...
const PageLayout: React.FC<IPageLayout> = ({
  ...
  const handlePageChange = (path: string) => {
    ...
    history.push({
      pathname: path
        .replace(
          '/analysis/performance/network/:networkId',
          `/analysis/performance/network/${params.networkId}`,
        )
        .replace(
          '/analysis/performance/service/:serviceId/:networkId',
          `/analysis/performance/service/${params.serviceId}/${params.networkId}`,
        )
