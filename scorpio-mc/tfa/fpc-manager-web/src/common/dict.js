 ...
 * 清理数据日志
 */
export const SYSTEM_LOG_DATA_CLEAR = '104';
 ...
 * license类型：测试演示版
 */
export const LICENSE_TYPE_DEMO = 'demo';

/**
 * license类型：正式商用版
 */
export const LICENSE_TYPE_COMMERCIAL = 'commercial';
 ...
 * 网格视图
 */
export const VMODE_GRID = 'grid';

/**
 * 列表视图
 */
export const VMODE_LIST = 'list';
 ...
 * 统计时，可选择的时间范围
 */
export const STATISTICS_TIME_RANGE = [
  {
    key: 'now-30m',
    name: '最近30分钟',
    interval: 30, // 时间间隔 30s
  },
  {
    key: 'now-1h',
    name: '最近1小时',
  ...
  },
  {
    key: 'now-1d',
    name: '最近1天',
    interval: 5 * 60, // 时间间隔 5分钟
  },
  {
    key: 'now-7d',
    name: '最近7天',
    interval: 60 * 60, // 时间间隔 1小时
  },
  {
    key: 'now-1M',
    name: '最近1个月',
    interval: 24 * 60 * 60, // 时间间隔 1天
  },
];
 ...
 * 页面中，搜索条件默认是否显示
 */
export const SEARCH_FORM_DEFAULT_SHOW = true;
 ...
 * 业务接口类型：默认口
 */
export const DEVICE_NETIF_CATEGORY_DEFAULT = ' ';
/**
 * 业务接口类型：管理口
 */
 ...
 * 业务接口类型：netflow
 */
export const DEVICE_NETIF_CATEGORY_NETFLOW = '3';

export const DEVICE_NETIF_CATEGORY_LIST = [
  {
    key: DEVICE_NETIF_CATEGORY_DEFAULT,
    label: '未配置',
  },
  {
  ...
  {
    key: DEVICE_NETIF_CATEGORY_NETFLOW,
    label: 'netflow',
  },
];
