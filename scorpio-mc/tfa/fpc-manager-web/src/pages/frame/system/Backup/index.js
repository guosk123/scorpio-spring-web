...
import { BACKUP_PATH } from '@/common/applicationConfig';
import { BOOL_NO, BOOL_YES, SYSTEM_LOG_CATEGORY_SYSTEM_BACKUP } from '@/common/dict';
import { Form } from '@ant-design/compatible';
import '@ant-design/compatible/assets/index.css';
import { CopyOutlined } from '@ant-design/icons';
import { Button, Card, InputNumber, message, Modal, Skeleton, Switch, Table, Tooltip } from 'antd';
...
class Backup extends PureComponent {
  ...
  handleTableChange = (pageObj) => {
    ...
    this.getLogs(pageSize === pagination.pageSize ? current : 1, pageSize);
  };
        ...
        <Skeleton active loading={queryLoading}>
          <Form {...formItemLayout} onSubmit={this.handleSubmit}>
            ...
            <Form.Item label="备份路径" style={{ marginBottom: 10 }}>
              ...
              <span className="ant-form-text">
                {' '}
                <CopyToClipboard text={BACKUP_PATH} onCopy={() => message.success('复制成功')}>
                  <Tooltip title="复制">
                    <CopyOutlined />
                  </Tooltip>
                </CopyToClipboard>
