...
export interface IPerformanceMetric {
  ...
  /** 内网区分字段 */
  serverResponseLatencyInsideService: number;
  serverResponseLatencyCountsInsideService: number;
  serverResponseLatencyPeakInsideService: number;
  serverResponseFastCountsInsideService: number;
  serverResponseNormalCountsInsideService: number;
  serverResponseTimeoutCountsInsideService: number;
  tcpClientNetworkLatencyInsideService: number;
  tcpClientNetworkLatencyCountsInsideService: number;
  tcpServerNetworkLatencyInsideService: number;
  tcpServerNetworkLatencyCountsInsideService: number;
  tcpClientRetransmissionPacketsInsideService: number;
  tcpServerRetransmissionPacketsInsideService: number;
  /** 外网区分字段 */
  serverResponseLatencyOutsideService: number;
  serverResponseLatencyCountsOutsideService: number;
  serverResponseLatencyPeakOutsideService: number;
  serverResponseFastCountsOutsideService: number;
  serverResponseNormalCountsOutsideService: number;
  serverResponseTimeoutCountsOutsideService: number;
  tcpClientNetworkLatencyOutsideService: number;
  tcpClientNetworkLatencyCountsOutsideService: number;
  tcpServerNetworkLatencyOutsideService: number;
  tcpServerNetworkLatencyCountsOutsideService: number;
  tcpClientRetransmissionPacketsOutsideService: number;
  tcpServerRetransmissionPacketsOutsideService: number;
}
...
export interface ITcpMetric {
  ...
  /** 内网字段 */
  tcpEstablishedSuccessCountsInsideService: number;
  tcpEstablishedFailCountsInsideService: number;
  tcpClientSynPacketsInsideService: number;
  tcpServerSynPacketsInsideService: number;
  tcpClientRetransmissionPacketsInsideService: number;
  tcpClientPacketsInsideService: number;
  tcpServerRetransmissionPacketsInsideService: number;
  tcpServerPacketsInsideService: number;
  tcpClientZeroWindowPacketsInsideService: number;
  tcpServerZeroWindowPacketsInsideService: number;

  /** 外网字段 */
  tcpEstablishedSuccessCountsOutsideService: number;
  tcpEstablishedFailCountsOutsideService: number;
  tcpClientSynPacketsOutsideService: number;
  tcpServerSynPacketsOutsideService: number;
  tcpClientRetransmissionPacketsOutsideService: number;
  tcpClientPacketsOutsideService: number;
  tcpServerRetransmissionPacketsOutsideService: number;
  tcpServerPacketsOutsideService: number;
  tcpClientZeroWindowPacketsOutsideService: number;
  tcpServerZeroWindowPacketsOutsideService: number;
}
...
export interface IIPGraphQueryHistory {
  id: string;
  name: string;
  historyGraphIds: string[];
  ipAddress?: string | undefined;
  sortProperty?: 'totalBytes' | 'establishedSessions' | undefined;
  minEstablishedSessions?: number | undefined;
