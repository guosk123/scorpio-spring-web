...
const Settings: React.FC<ISettingProps> = ({ config, isLoading, refreshConfig }) => {
  ...
  const updateThresholdConfig = (thresholdConfig: any[], key: string) => {
    // console.log(key, 'keyYes', thresholdConfig, 'thresholdConfigYes');
  ...
  useEffect(() => {
    console.log(displayFieldIdThresholdMap, 'displayFieldIdThresholdMap');
  }, [displayFieldIdThresholdMap]);
