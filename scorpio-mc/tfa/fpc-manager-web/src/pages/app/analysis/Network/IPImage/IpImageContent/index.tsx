...
import type { ISearchBoxInfo, IShowCategory, PositionDetail } from '../typings';
...
const IPImageContent: React.FC<SearchProps> = ({
  ...
  // useEffect(() => {
  //   console.log(currentLayoutMessages, 'nowLayoutMessage');
  //   // changePositionMessages(currentLayoutMessages);
  // }, [currentLayoutMessages]);
  ...
  // const handleDragStop = (a: any, b: any, c: any, d: any, e: any) => {
  //   console.log(a, 'a');
  // };

  // const changePositionLayout = (layouts: any) => {
  //   layouts.map((layout: any) => {
  //     const layoutId = layout.i;
  //     setCurrentLayoutMessages((prev: Record<IShowCategory, PositionDetail>) => {
