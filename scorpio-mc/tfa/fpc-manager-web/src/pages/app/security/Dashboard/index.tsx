...
import useCmsState from '../../configuration/components/hooks/useCmsState';
...
const Dashboard = () => {
  ...
  const connectCmsState = useCmsState();
  ...
  return (
    ...
    >
      ...
      <Row gutter={[10, 10]} align="middle">
        ...
        <Col span={12}>
          <BarChart
            menus={connectCmsState ? ['alarm', 'flow'] : ['alarm', 'surRule', 'stopRule', 'flow']}
            title="TOP10告警"
