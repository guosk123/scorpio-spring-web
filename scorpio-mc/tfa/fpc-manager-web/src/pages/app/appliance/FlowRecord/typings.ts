...
import type { ESourceType } from '../../analysis/typings';
...
export interface IFlowRecordData {
  ...
  /** 源目的IP标签 */
  ip_label_initiator?: string;
  ip_label_responder?: string;
  /** nat源目地ip端口， */
  ip_nat_initiator?: string;
  ip_nat_responder?: string;
  port_nat_initiator?: number;
  port_nat_responder?: number;
}
