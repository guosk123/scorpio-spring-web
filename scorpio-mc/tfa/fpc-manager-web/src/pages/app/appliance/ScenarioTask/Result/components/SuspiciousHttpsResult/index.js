...
class SuspiciousHttpsResult extends PureComponent {
  constructor(props) {
    super(props);
    ...
    const columns = [
      ...
      },
      {
        ...
        render: (text, record) => (
          <Link
            to={getLinkUrl(
              `/analysis/security/scenario-task/result/metadata-ssl?analysisResultId=${
                record.id
...
export default SuspiciousHttpsResult;
