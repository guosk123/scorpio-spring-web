...
const FlowAnalysis: React.FC<IFlowLayout> = ({ location: { pathname }, children, ...rest }) => {
  ...
  // 维度名称
  const [fieldName, setFieldName] = useState<string>(pathname.split('/').pop() as string);
  ...
  return (
    <>
      ...
      <FilterContext.Provider value={{ filterCondition, addConditionToFilter, filterField }}>
