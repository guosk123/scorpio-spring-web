...
import { tableColumns as httpColumns } from '@/pages/app/appliance/Metadata/HTTP';
...
import { tableColumns as dhcpColumns } from '@/pages/app/appliance/Metadata/DHCP';
import { tableColumns as dhcpv6Columns } from '@/pages/app/appliance/Metadata/DHCPV6';
...
export const METADATA_FIELD_MAP = {
  ...
  [EMetadataProtocol.SMTP]: mailColumns,
  [EMetadataProtocol.POP3]: mailColumns,
  [EMetadataProtocol.IMAP]: mailColumns,
  ...
  [EMetadataProtocol.ICMP]: icmpv4Columns,
  ...
  'mail-pop3': mailColumns,
  'mail-smtp': mailColumns,
  'mail-imap': mailColumns,
  dhcp_v6: dhcpv6Columns,
};

/** 元数据和table名称对应的map */
export const METADATA_TABLE_MAP = {
  mysql: 't_fpc_protocol_mysql_log_record',
  pgsql: 't_fpc_protocol_postgresql_log_record',
  arp: 't_fpc_protocol_arp_log_record',
  sip: 't_fpc_protocol_sip_log_record',
  dns: 't_fpc_protocol_dns_log_record',
  icmp: 't_fpc_protocol_icmp_log_record',
  ssh: 't_fpc_protocol_ssh_log_record',
  dhcp: 't_fpc_protocol_dhcp_log_record',
  dhcp_v6: 't_fpc_protocol_dhcp_log_record',
  ssl: 't_fpc_protocol_ssl_log_record',
  ftp: 't_fpc_protocol_ftp_log_record',
  telnet: 't_fpc_protocol_telnet_log_record',
  socks4: 't_fpc_protocol_socks4_log_record',
  socks5: 't_fpc_protocol_socks5_log_record',
  'mail-pop3': 't_fpc_protocol_mail_log_record',
  'mail-smtp': 't_fpc_protocol_mail_log_record',
  'mail-imap': 't_fpc_protocol_mail_log_record',
  tds: 't_fpc_protocol_tds_log_record',
  // rtp: 't_fpc_protocol_rtp_log_record',
  tns: 't_fpc_protocol_tns_log_record',
  db2: 't_fpc_protocol_db2_log_record',
  http: 't_fpc_protocol_http_log_record',
  ospf: 't_fpc_protocol_ospf_log_record',
  ldap: 't_fpc_protocol_ldap_log_record',
};

/** 统计和table名称对应的map */
export const STATISTICS_TABLE_MAP = {
  statistics_forward: 't_fpc_metric_forward_data_record',
  statistics_dhcp: 't_fpc_metric_dhcp_data_record',
  statistics_dhcp_v6: 't_fpc_metric_dhcp_data_record',
  http_request_info: 't_fpc_metric_http_request_data_record',
  metric_diskio: 't_fpc_metric_disk_io_data_record',
  statistics_l3device: 't_fpc_metric_l3device_data_record',
  statistics_port: 't_fpc_metric_port_data_record',
  statistics_location: 't_fpc_metric_location_data_record',
  statistics_network: 't_fpc_metric_network_data_record',
  statistics_l2device: 't_fpc_metric_l2device_data_record',
  statistics_service: 't_fpc_metric_service_data_record',
  statistics_dscp: 't_fpc_metric_dscp_data_record',
  http_terminal_info: 't_fpc_metric_os_data_record',
  system_monitor: 't_fpc_metric_monitor_data_record',
  http_status_info: 't_fpc_metric_http_analysis_data_record',
  statistics_application: 't_fpc_metric_application_data_record',
  statistics_hostgroup: 't_fpc_metric_hostgroup_data_record',
  statistics_netif: 't_fpc_metric_netif_data_record',
  statistics_ip_conversation: 't_fpc_metric_ip_conversation_data_record',
  statistics_l7protocol: 't_fpc_metric_l7protocol_data_record',
};
...
export const FLOW_LOG_TABLE_MAP = {
  flowlog: 't_fpc_flow_log_record',
};

/** 安全告警和table对应map */
export const SURICATA_TABLE_MAP = {
  suricata: 't_fpc_analysis_suricata_alert_message',
};
