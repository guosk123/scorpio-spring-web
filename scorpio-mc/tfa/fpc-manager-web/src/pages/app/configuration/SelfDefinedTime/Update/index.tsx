...
import { querySelfDefinedTimeDetail } from '../services';
import { EPageMode } from '@/pages/app/appliance/TransmitTask/components/TransmitTaskForm';

export default function UpdateSelfDefinedTimeDetail() {
  ...
  useEffect(() => {
    setLoading(true);
    querySelfDefinedTimeDetail({ id: params.taskId }).then((res) => {
