...
import { matadataDetailKV } from '@/pages/app/appliance/Metadata/Analysis/typings';

/** TDS 的 ID */
const L7_PROTOCOL_TDS_ID = 645;

const L7_PROTOCOL_SIP_ID = 307;

const L7_PROTOCOL_SOCKS4_ID = 843;
  ...
  effects: {
    *queryAllProtocols(_, { call, put }) {
      ...
      allL7ProtocolsList.forEach((item) => {
        ...
        // LDAP&db2
        // if (item.protocolId === '596' || item.protocolId === '650') {
        //   metadataProtocolsList.push(item);
        // }
