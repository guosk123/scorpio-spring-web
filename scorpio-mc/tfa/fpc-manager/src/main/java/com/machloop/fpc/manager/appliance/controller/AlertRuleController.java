...
import com.machloop.fpc.manager.appliance.vo.AlertRuleCreationVO;
import com.machloop.fpc.manager.appliance.vo.AlertRuleModificationVO;
...
public class AlertRuleController {
  ...
  private static Map<String, Object> alertRuleBO2Map(AlertRuleBO alertRuleBO) {
    ...
    map.put("customTimeId", alertRuleBO.getCustomTimeId());
