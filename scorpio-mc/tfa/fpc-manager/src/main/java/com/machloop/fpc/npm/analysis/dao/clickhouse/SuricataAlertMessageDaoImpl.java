...
public class SuricataAlertMessageDaoImpl implements SuricataAlertMessageDao {
  ...
  private static final String TABLE_ANALYSIS_SURICATA_ALERT = "t_fpc_analysis_suricata_alert_message";
  ...
  public Page<SuricataAlertMessageDO> querySuricataAlerts(Pageable page,
    ...
    List<Map<String, Object>> suricataAlerts = clickHouseTemplate.getJdbcTemplate()
    ...
    Long total = clickHouseTemplate.getJdbcTemplate().queryForObject(totalSql.toString(), params,
        Long.class);
  ...
  @Override
  public List<Object> querySuricataTopHundredFlowIds(Integer sid, Date startTimeDate,
      Date endTimeDate) {
    ...
    List<Object> flowIds = clickHouseTemplate.getJdbcTemplate().queryForList(sql.toString(), params,
        Object.class);
  ...
  /**
   * @see com.machloop.fpc.npm.analysis.dao.SuricataAlertMessageDao#querySuricataAlertsWithoutTotal(com.machloop.alpha.common.base.page.Pageable, com.machloop.fpc.npm.analysis.vo.SuricataRuleQueryVO)
   */
  @Override
  public List<Map<String, Object>> querySuricataAlertsWithoutTotal(Pageable page,
      SuricataRuleQueryVO queryVO) {
    StringBuilder sql = buildSelectStatement();
  ...
  public Page<Map<String, Object>> querySuricataAlertMessagesAsGraph(SuricataRuleQueryVO queryVO,
    ...
    List<Map<String, Object>> suricataAlertMessages = clickHouseTemplate.getJdbcTemplate()
        .query(sql.toString(), params, new ColumnMapRowMapper());
  ...
  public List<Map<String, Object>> queryAlterMessagesRelation(String ip, Date startTimeDate,
    ...
    List<Map<String, Object>> suricataRelation = clickHouseTemplate.getJdbcTemplate()
        .query(sql.toString(), params, new ColumnMapRowMapper());
