...
public class SuricataAlertMessageController {
  ...
  @GetMapping("/alert-messages/packets")
  @Secured({"PERM_USER"})
  public Map<String, Object> fetchFlowPacketFileUrls(String queryId, SuricataRuleQueryVO queryVO,
      @RequestParam(
    ...
    return suricataAlertMessageService.fetchFlowLogPacketFileUrls(queryId, fileType, queryVO, sort);
  }
