...
import com.machloop.fpc.manager.metadata.vo.ProtocolSocks5LogVO;
...
public class ProtocolSocks5LogController {

  private static final Logger LOGGER = LoggerFactory.getLogger(ProtocolSocks5LogController.class);

  @Autowired
  @Qualifier("protocolSocks5LogService")
  private LogRecordService<ProtocolSocks5LogVO> logRecordService;

  @Autowired
  private ScenarioTaskResultService scenarioTaskResultService;

  @GetMapping("/protocol-socks5-logs")
  @Secured({"PERM_USER"})
  public Page<ProtocolSocks5LogVO> queryLogRecords(
  ...
  @GetMapping("/protocol-socks5-logs/as-statistics")
  @Secured({"PERM_USER"})
  ...
  @GetMapping("/protocol-socks5-logs/via-dsl")
  @Secured({"PERM_USER"})
  public String queryLogRecordViaDsl(@RequestParam String dsl) {
    return logRecordService.queryLogRecordsViaDsl(dsl);
  }

  @GetMapping("/protocol-socks5-logs/{id}")
  @Secured({"PERM_USER"})
  public ProtocolSocks5LogVO queryLogRecord(@PathVariable String id, LogRecordQueryVO queryVO) {

    return logRecordService.queryLogRecord(queryVO, id);
  }

  @GetMapping("/protocol-socks5-logs/packets")
  @Secured({"PERM_USER"})
  ...
  @GetMapping("/protocol-socks5-logs/as-export")
  @Secured({"PERM_USER"})
  public void exportLogRecords(@RequestParam(required = false, defaultValue = "") String startTime,
    ...
    try (OutputStream out = response.getOutputStream();) {
      ...
      LOGGER.warn("export socks5 logs error ", e);
    }
  }
}
