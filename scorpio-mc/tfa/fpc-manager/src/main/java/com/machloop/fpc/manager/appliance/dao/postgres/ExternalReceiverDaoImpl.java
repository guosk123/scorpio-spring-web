...
public class ExternalReceiverDaoImpl implements ExternalReceiverDao {
  ...
  private static final String TABLE_APPLIANCE_EXTERNAL_RECEIVER = "fpc_appliance_external_receiver";
  ...
  @Override
  public ExternalReceiverDO queryExternalReceiverByExternalReceiverInCmsId(
      String externalReceiverInCmsId) {
    StringBuilder sql = buildSelectStatement();
    sql.append(" where deleted = :deleted ");
    sql.append(" and external_receiver_in_cms_id = :externalReceiverInCmsId ");

    Map<String, Object> params = Maps.newHashMapWithExpectedSize(Constants.MAP_DEFAULT_SIZE);
    params.put(BaseOperateDO.DELETED_FIELD, Constants.BOOL_NO);
    params.put("externalReceiverInCmsId", externalReceiverInCmsId);
  ...
  public List<String> queryExternalReceiverIds(boolean onlyLocal) {
    ...
    if (onlyLocal) {
      sql.append(" and external_receiver_in_cms_id = '' ");
    }
  ...
  @Override
  public List<String> queryAssignExternalReceivers(Date beforeTime) {
    StringBuilder sql = new StringBuilder();
    sql.append("select external_receiver_in_cms_id from ")
        .append(TABLE_APPLIANCE_EXTERNAL_RECEIVER);
    sql.append(" where deleted = :deleted and external_receiver_in_cms_id != '' ");
  ...
  public List<ExternalReceiverDO> queryMailExternalReceivers() {
    ...
    params.put(BaseOperateDO.DELETED_FIELD, Constants.BOOL_NO);
    params.put("receiverType", FpcConstants.APPLIANCE_EXTERNAL_RECEIVER_TYPE_MAIL);
  ...
  public void saveExternalReceiver(ExternalReceiverDO externalReceiverDO) {
    ...
    sql.append(" (id, name, receiver_content, receiver_type, external_receiver_in_cms_id, ");
    sql.append(" update_time, create_time, operator_id) ");
    sql.append(" values (:id, :name, :receiverContent, :receiverType, :externalReceiverInCmsId, ");
  ...
  private StringBuilder buildSelectStatement() {
    ...
    StringBuilder sql = new StringBuilder();
    sql.append(" select id, name, receiver_content, receiver_type, external_receiver_in_cms_id, ");
