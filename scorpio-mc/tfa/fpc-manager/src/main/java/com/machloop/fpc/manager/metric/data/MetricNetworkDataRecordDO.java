 ...
 */
public class MetricNetworkDataRecordDO extends AbstractDataRecordDO {
  ...
  // IP协议包数统计
  private long tcpTotalPackets;
  private long udpTotalPackets;
  private long icmpTotalPackets;
  private long icmp6TotalPackets;
  private long otherTotalPackets;
  // 分片数据包统计
  ...
  // 包长统计
  private long tinyPackets;
  private long smallPackets;
  private long mediumPackets;
  private long bigPackets;
  private long largePackets;
  private long hugePackets;
  private long jumboPackets;
  private long packetLengthAvg;
  // 会话统计
  ...
  // 以太网包数统计
  private long ipv4Frames;
  private long ipv6Frames;
  private long arpFrames;
  private long ieee8021xFrames;
  private long ipxFrames;
  private long lacpFrames;
  private long mplsFrames;
  private long stpFrames;
  private long otherFrames;
  // 数据包类型统计
  private long unicastBytes;
  private long broadcastBytes;
  private long multicastBytes;
  // 性能统计
  ...
  // Performance和TCP指标
  @JsonIgnore
  private double tcpClientRetransmissionRateInsideService;
  @JsonIgnore
  private double tcpServerRetransmissionRateInsideService;
  @JsonIgnore
  private double tcpClientNetworkLatencyAvgInsideService;
  @JsonIgnore
  private double tcpServerNetworkLatencyAvgInsideService;
  @JsonIgnore
  private double serverResponseLatencyAvgInsideService;

  @JsonIgnore
  private double tcpClientRetransmissionRateOutsideService;
  @JsonIgnore
  private double tcpServerRetransmissionRateOutsideService;
  @JsonIgnore
  private double tcpClientNetworkLatencyAvgOutsideService;
  @JsonIgnore
  private double tcpServerNetworkLatencyAvgOutsideService;
  @JsonIgnore
  private double serverResponseLatencyAvgOutsideService;

  @Override
  public String toString() {
    return "MetricNetworkDataRecordDO{" + "bytepsPeak=" + bytepsPeak + ", packetpsPeak="
        ...
        + ", tcpTotalPackets=" + tcpTotalPackets + ", udpTotalPackets=" + udpTotalPackets
        + ", icmpTotalPackets=" + icmpTotalPackets + ", icmp6TotalPackets=" + icmp6TotalPackets
        + ", otherTotalPackets=" + otherTotalPackets + ", fragmentTotalBytes=" + fragmentTotalBytes
        + ", fragmentTotalPackets=" + fragmentTotalPackets + ", tcpSynPackets=" + tcpSynPackets
        + ", tcpClientSynPackets=" + tcpClientSynPackets + ", tcpServerSynPackets="
        + tcpServerSynPackets + ", tcpSynAckPackets=" + tcpSynAckPackets + ", tcpSynRstPackets="
        + tcpSynRstPackets + ", tcpEstablishedTimeAvg=" + tcpEstablishedTimeAvg
        + ", tcpZeroWindowPackets=" + tcpZeroWindowPackets + ", tinyPackets=" + tinyPackets
        + ", smallPackets=" + smallPackets + ", mediumPackets=" + mediumPackets + ", bigPackets="
        + bigPackets + ", largePackets=" + largePackets + ", hugePackets=" + hugePackets
        + ", jumboPackets=" + jumboPackets + ", packetLengthAvg=" + packetLengthAvg
        + ", activeSessions=" + activeSessions + ", concurrentSessions=" + concurrentSessions
        + ", concurrentTcpSessions=" + concurrentTcpSessions + ", concurrentUdpSessions="
        + concurrentUdpSessions + ", concurrentArpSessions=" + concurrentArpSessions
        + ", concurrentIcmpSessions=" + concurrentIcmpSessions + ", destroyedSessions="
        + destroyedSessions + ", establishedTcpSessions=" + establishedTcpSessions
        + ", establishedUdpSessions=" + establishedUdpSessions + ", establishedIcmpSessions="
        + establishedIcmpSessions + ", establishedOtherSessions=" + establishedOtherSessions
        + ", establishedUpstreamSessions=" + establishedUpstreamSessions
        + ", establishedDownstreamSessions=" + establishedDownstreamSessions + ", ipv4Frames="
        + ipv4Frames + ", ipv6Frames=" + ipv6Frames + ", arpFrames=" + arpFrames
        + ", ieee8021xFrames=" + ieee8021xFrames + ", ipxFrames=" + ipxFrames + ", lacpFrames="
        + lacpFrames + ", mplsFrames=" + mplsFrames + ", stpFrames=" + stpFrames + ", otherFrames="
        + otherFrames + ", unicastBytes=" + unicastBytes + ", broadcastBytes=" + broadcastBytes
        + ", multicastBytes=" + multicastBytes + ", serverResponseFastCounts="
        + serverResponseFastCounts + ", serverResponseNormalCounts=" + serverResponseNormalCounts
        + ", serverResponseTimeoutCounts=" + serverResponseTimeoutCounts
        + ", serverResponseLatencyPeak=" + serverResponseLatencyPeak + ", uniqueIpCounts="
        + uniqueIpCounts + ", ServerResponseLatencyInsideService="
  ...
  public long getTcpTotalPackets() {
    return tcpTotalPackets;
  }

  public void setTcpTotalPackets(long tcpTotalPackets) {
    this.tcpTotalPackets = tcpTotalPackets;
  }

  public long getUdpTotalPackets() {
    return udpTotalPackets;
  }

  public void setUdpTotalPackets(long udpTotalPackets) {
    this.udpTotalPackets = udpTotalPackets;
  }

  public long getIcmpTotalPackets() {
    return icmpTotalPackets;
  }

  public void setIcmpTotalPackets(long icmpTotalPackets) {
    this.icmpTotalPackets = icmpTotalPackets;
  }

  public long getIcmp6TotalPackets() {
    return icmp6TotalPackets;
  }

  public void setIcmp6TotalPackets(long icmp6TotalPackets) {
    this.icmp6TotalPackets = icmp6TotalPackets;
  }

  public long getOtherTotalPackets() {
    return otherTotalPackets;
  }

  public void setOtherTotalPackets(long otherTotalPackets) {
    this.otherTotalPackets = otherTotalPackets;
  }
  ...
  public long getTinyPackets() {
    return tinyPackets;
  }

  public void setTinyPackets(long tinyPackets) {
    this.tinyPackets = tinyPackets;
  }

  public long getSmallPackets() {
    return smallPackets;
  }

  public void setSmallPackets(long smallPackets) {
    this.smallPackets = smallPackets;
  }

  public long getMediumPackets() {
    return mediumPackets;
  }

  public void setMediumPackets(long mediumPackets) {
    this.mediumPackets = mediumPackets;
  }

  public long getBigPackets() {
    return bigPackets;
  }

  public void setBigPackets(long bigPackets) {
    this.bigPackets = bigPackets;
  }

  public long getLargePackets() {
    return largePackets;
  }

  public void setLargePackets(long largePackets) {
    this.largePackets = largePackets;
  }

  public long getHugePackets() {
    return hugePackets;
  }

  public void setHugePackets(long hugePackets) {
    this.hugePackets = hugePackets;
  }

  public long getJumboPackets() {
    return jumboPackets;
  }

  public void setJumboPackets(long jumboPackets) {
    this.jumboPackets = jumboPackets;
  }

  public long getPacketLengthAvg() {
    return packetLengthAvg;
  }

  public void setPacketLengthAvg(long packetLengthAvg) {
    this.packetLengthAvg = packetLengthAvg;
  }
  ...
  public long getIpv4Frames() {
    return ipv4Frames;
  }

  public void setIpv4Frames(long ipv4Frames) {
    this.ipv4Frames = ipv4Frames;
  }

  public long getIpv6Frames() {
    return ipv6Frames;
  }

  public void setIpv6Frames(long ipv6Frames) {
    this.ipv6Frames = ipv6Frames;
  }

  public long getArpFrames() {
    return arpFrames;
  }

  public void setArpFrames(long arpFrames) {
    this.arpFrames = arpFrames;
  }

  public long getIeee8021xFrames() {
    return ieee8021xFrames;
  }

  public void setIeee8021xFrames(long ieee8021xFrames) {
    this.ieee8021xFrames = ieee8021xFrames;
  }

  public long getIpxFrames() {
    return ipxFrames;
  }

  public void setIpxFrames(long ipxFrames) {
    this.ipxFrames = ipxFrames;
  }

  public long getLacpFrames() {
    return lacpFrames;
  }

  public void setLacpFrames(long lacpFrames) {
    this.lacpFrames = lacpFrames;
  }

  public long getMplsFrames() {
    return mplsFrames;
  }

  public void setMplsFrames(long mplsFrames) {
    this.mplsFrames = mplsFrames;
  }

  public long getStpFrames() {
    return stpFrames;
  }

  public void setStpFrames(long stpFrames) {
    this.stpFrames = stpFrames;
  }
  ...
  public void setOtherFrames(long otherFrames) {
    this.otherFrames = otherFrames;
  }

  public long getUnicastBytes() {
    return unicastBytes;
  }

  public void setUnicastBytes(long unicastBytes) {
    this.unicastBytes = unicastBytes;
  }
  ...
  public void setBroadcastBytes(long broadcastBytes) {
    this.broadcastBytes = broadcastBytes;
  }

  public long getMulticastBytes() {
    return multicastBytes;
  }

  public void setMulticastBytes(long multicastBytes) {
    this.multicastBytes = multicastBytes;
  }
