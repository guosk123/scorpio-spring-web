...
public class SmtpConfigurationDaoImpl implements SmtpConfigurationDao {
  ...
  public static final String TABLE_APPLIANCE_SMTP_CONFIGURATION = "fpc_appliance_smtp_configuration";

  @Autowired
  private NamedParameterJdbcTemplate jdbcTemplate;

  /**
   * @see com.machloop.fpc.manager.appliance.dao.SmtpConfigurationDao#querySmtpConfigurations()
   */
  @Override
  ...
  /**
   * @see com.machloop.fpc.manager.appliance.dao.SmtpConfigurationDao#saveOrUpdateSmtpConfiguration(com.machloop.fpc.manager.appliance.data.SmtpConfigurationDO)
   */
  @Override
