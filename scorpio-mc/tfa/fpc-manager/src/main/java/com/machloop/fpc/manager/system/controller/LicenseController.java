 ...
 * @author liyongjun
 *
 * create at 2019年12月12日, fpc-manager
 */
@RestController
...
public class LicenseController {
  ...
  public Map<String, Object> queryLicense() {
    ...
    resultMap.put("packetTimeLimit", license.getPacketTimeLimit());
    resultMap.put("packetCapacityLimit", license.getPacketCapacityLimit());
    resultMap.put("recvSpeedLimit", license.getRecvSpeedLimit());
