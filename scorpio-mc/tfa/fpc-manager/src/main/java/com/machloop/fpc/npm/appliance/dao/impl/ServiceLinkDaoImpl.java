...
import com.machloop.fpc.npm.appliance.dao.ServiceLinkDao;
...
public class ServiceLinkDaoImpl implements ServiceLinkDao {
  ...
  private static final String TABLE_APPLIANCE_SERVICE_LINK = "fpc_appliance_service_link";

  @Autowired
  private NamedParameterJdbcTemplate jdbcTemplate;

  /**
   * @see com.machloop.fpc.npm.appliance.dao.ServiceLinkDao#queryServiceLinks()
   */
  @Override
  ...
  /**
   * @see com.machloop.fpc.npm.appliance.dao.ServiceLinkDao#queryServiceLink(java.lang.String)
   */
  @Override
  ...
  /**
   * @see com.machloop.fpc.npm.appliance.dao.ServiceLinkDao#queryAssignServiceLinks(java.util.Date)
   */
  @Override
  public List<String> queryAssignServiceLinks(Date beforeTime) {
    StringBuilder sql = new StringBuilder();
    sql.append("select service_link_in_cms_id from ").append(TABLE_APPLIANCE_SERVICE_LINK);
    sql.append(" where service_link_in_cms_id != '' ");
  ...
  /**
   * @see com.machloop.fpc.npm.appliance.dao.ServiceLinkDao#saveOrUpdateServiceLink(com.machloop.fpc.npm.appliance.data.ServiceLinkDO)
   */
  @Override
  ...
  /**
   * @see com.machloop.fpc.npm.appliance.dao.ServiceLinkDao#batchSaveServiceLink(java.util.List)
   */
  @Override
  ...
  /**
   * @see com.machloop.fpc.npm.appliance.dao.ServiceLinkDao#deleteServiceLink(java.lang.String)
   */
  @Override
