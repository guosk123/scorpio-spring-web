...
public class SaHierarchyDaoImpl implements SaHierarchyDao {
  ...
  private static final String TABLE_APPLIANCE_SA_HIERARCHY = "fpc_appliance_sa_hierarchy";

  @Autowired
  private NamedParameterJdbcTemplate jdbcTemplate;

  /**
   * @see com.machloop.fpc.manager.knowledge.dao.SaHierarchyDao#querySaHierarchys(java.lang.String, java.lang.String, java.lang.String)
   */
  @Override
  ...
  /**
   * @see com.machloop.fpc.manager.knowledge.dao.SaHierarchyDao#querySaHierarchyBySubCategoryIds(java.util.List)
   */
  @Override
  ...
  /**
   * @see com.machloop.fpc.manager.knowledge.dao.SaHierarchyDao#querySaHierarchyByApplicationIds(java.util.List)
   */
  @Override
  ...
  /**
   * @see com.machloop.fpc.manager.knowledge.dao.SaHierarchyDao#batchSaveSaHierarchy(java.util.List)
   */
  @Override
  ...
  /**
   * @see com.machloop.fpc.manager.knowledge.dao.SaHierarchyDao#batchUpdateAppsBySubCategory(java.util.List, java.lang.String, java.lang.String)
   */
  @Override
  public int batchUpdateAppsBySubCategory(List<String> subCategoryIds, String categoryId,
    ...
    params.put("type", String.valueOf(FpcConstants.METRIC_TYPE_APPLICATION_APP));
    params.put("subCategoryIds", subCategoryIds);
  ...
  /**
   * @see com.machloop.fpc.manager.knowledge.dao.SaHierarchyDao#batchDeleteByCategoryId(java.lang.String)
   */
  @Override
  ...
  /**
   * @see com.machloop.fpc.manager.knowledge.dao.SaHierarchyDao#batchDeleteBySubCategoryIds(java.lang.String, java.util.List)
   */
  @Override
  ...
  /**
   * @see com.machloop.fpc.manager.knowledge.dao.SaHierarchyDao#batchDeleteByApplicationIds(java.lang.String, java.util.List)
   */
  @Override
