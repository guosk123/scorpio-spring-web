...
public class MetricController {
  ...
  @GetMapping("/forward-policies/as-histogram")
  @Secured({"PERM_USER"})
  public List<Map<String, Object>> queryMetricForwardPolicyHistograms(
      @Validated MetricQueryVO queryVO, @RequestParam String policyId) {
    ...
    return metricService.queryMetricForwardPolicyHistograms(queryVO, policyId, false);
  }
  ...
  public List<Map<String, Object>> queryMetricApplications(@Validated MetricQueryVO queryVO,
      @RequestParam(
          required = false, defaultValue = FpcConstants.METRIC_TYPE_APPLICATION_APP + "") int type,
      @RequestParam(required = false, defaultValue = "total_bytes") String sortProperty,
      @RequestParam(required = false, defaultValue = "desc") String sortDirection) {
  ...
  public List<Map<String, Object>> graphMetricIpConversations(@Validated MetricQueryVO queryVO,
      ...
      @RequestParam(required = false, defaultValue = "0") String aggApplication,
      @RequestParam(required = false, defaultValue = "total_bytes") String sortProperty,
      @RequestParam(required = false, defaultValue = "desc") String sortDirection) {
    ...
    if (StringUtils.equals(queryVO.getDrilldown(), Constants.BOOL_YES)) {
      result = metricFlowlogService.graphMetricIpConversations(queryVO, minEstablishedSessions,
          minTotalBytes, aggApplication, sortProperty, sortDirection);
    } else {
