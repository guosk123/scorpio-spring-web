 ...
 */
@Service
public class MQAssignmentServiceImpl implements MQAssignmentService {

  private static final Logger LOGGER = LoggerFactory.getLogger(MQAssignmentServiceImpl.class);
  ...
  private static final List<
      String> TAGS = Lists.newArrayList(FpcCmsConstants.MQ_TAG_SSO, FpcCmsConstants.MQ_TAG_ALERT,
          FpcCmsConstants.MQ_TAG_INGESTPOLICY, FpcCmsConstants.MQ_TAG_EXTERNALRECEIVER,
          FpcCmsConstants.MQ_TAG_SENDRULE, FpcCmsConstants.MQ_TAG_SENDPOLICY,
          FpcCmsConstants.MQ_TAG_SERVICE, FpcCmsConstants.MQ_TAG_SERVICE_LINK,
          ...
          FpcCmsConstants.MQ_TAG_CUSTOMCATEGORY, FpcCmsConstants.MQ_TAG_HOSTGROUP,
          FpcCmsConstants.MQ_TAG_LOGICALSUBNET, FpcCmsConstants.MQ_TAG_FILTERRULE,
          FpcCmsConstants.MQ_TAG_SURICATA, FpcCmsConstants.MQ_TAG_SURICATA_RULE_CLASSTYPE,
          FpcCmsConstants.MQ_TAG_NETWORKPOLICY, FpcCmsConstants.MQ_TAG_DOMAIN_WHITE_LIST);

  /**
   * @see com.machloop.fpc.manager.cms.service.MQAssignmentService#assignConfiguration(org.apache.rocketmq.common.message.MessageExt)
   */
  @Override
  public ConsumeOrderlyStatus assignConfiguration(MessageExt message) {
  ...
  /**
   * @see com.machloop.fpc.manager.cms.service.MQAssignmentService#getAssignConfiguration(java.util.Date)
   */
  @Override
  ...
  /**
   * @see com.machloop.fpc.manager.cms.service.MQAssignmentService#clearLocalConfiguration(java.util.Date, boolean)
   */
  @Override
