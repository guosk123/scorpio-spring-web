...
public abstract class AbstractLogRecordVO {
  ...
  private List<String> networkText;
  ...
  public String toString() {
    return "AbstractLogRecordVO [policyName=" + policyName + ", level=" + level + ", flowId="
        + flowId + ", networkId=" + networkId + ", networkText=" + networkText + ", serviceId="
        + serviceId + ", serviceText=" + serviceText + ", applicationId=" + applicationId
        + ", srcIp=" + srcIp + ", srcPort=" + srcPort + ", destIp=" + destIp + ", destPort="
        + destPort + ", startTime=" + startTime + ", endTime=" + endTime + "]";
  }
  ...
  public List<String> getNetworkText() {
    return networkText;
  }

  public void setNetworkText(List<String> networkText) {
  ...
  public void setServiceText(List<String> serviceText) {
