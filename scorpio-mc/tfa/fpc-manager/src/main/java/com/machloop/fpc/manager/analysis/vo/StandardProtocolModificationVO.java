 ...
 */
public class StandardProtocolModificationVO {
  @NotEmpty(message = "修改协议配置时传入的id不能为空")
  private String id;
  ...
  public String toString() {
    return "StandardProtocolModificationVO [id=" + id + ", l7ProtocolId=" + l7ProtocolId
        + ", ipProtocol=" + ipProtocol + ", port=" + port + ", description=" + description + "]";
  }
