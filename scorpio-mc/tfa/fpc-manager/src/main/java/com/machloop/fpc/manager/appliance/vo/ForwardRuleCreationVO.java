 ...
 * @author ChenXiao
 *
 * create at 2022/5/7 15:48,IntelliJ IDEA
 *
 */
public class ForwardRuleCreationVO {

  @Length(min = 1, max = 30, message = "实时转发规则名称不能为空，最多可输入30个字符")
  private String name;
  ...
  @Override public String toString() {
    return "ForwardRuleCreationVO{" + "name='" + name + '\'' + ", defaultAction='" + defaultAction
