...
public class LogRecordQueryVO implements LogAudit {
  ...
  public String toString() {
    return "LogRecordQueryVO{" + "id='" + id + '\'' + ", keyword='" + keyword + '\'' + ", dsl='"
        ...
        + ", decrypted=" + decrypted + ", startTime='" + startTime + '\'' + ", endTime='" + endTime
        + '\'' + ", startTimeDate=" + startTimeDate + ", endTimeDate=" + endTimeDate
        + ", includeStartTime=" + includeStartTime + ", includeEndTime=" + includeEndTime
        + ", entry='" + entry + '\'' + ", hasAgingTime=" + hasAgingTime + ", timePrecision="
        + timePrecision + ", columns='" + columns + '\'' + ", count=" + count + ", srcIp='" + srcIp
        + '\'' + ", destIp='" + destIp + '\'' + ", fileType='" + fileType + '\'' + ", interval="
        + interval + '}';
  }
