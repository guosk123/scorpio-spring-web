...
public class PacketAnalysisQueryVO implements LogAudit {
  ...
  private String fileType = FpcConstants.PACKET_FILE_TYPE_PCAP;
  ...
  public Tuple2<String, Map<String, Object>> toParamUrlWithPlaceholder()
    ...
    paramMap.put("networkId",
        StringUtils.defaultIfBlank(networkId, StringUtils.isNotBlank(packetFileId) ? "" : "ALL"));
    paramMap.put("serviceId", StringUtils.defaultIfBlank(serviceId, ""));
    paramMap.put("packetFileId", StringUtils.defaultIfBlank(packetFileId, ""));
  ...
  public String toParamUrl() throws UnsupportedEncodingException {
    ...
    return "?queryId=" + queryId + "&startTime="
        ...
        + StringUtils.defaultIfBlank(networkId, StringUtils.isNotBlank(packetFileId) ? "" : "ALL")
        + "&serviceId=" + StringUtils.defaultIfBlank(serviceId, "") + "&packetFileId="
        + StringUtils.defaultIfBlank(packetFileId, "") + "&bpf="
        ...
        + "&fileType=" + StringUtils.defaultIfBlank(fileType, "");
  }

  @Override
  public String toString() {
    return "PacketAnalysisQueryVO [queryId=" + queryId + ", startTime=" + startTime + ", endTime="
        + endTime + ", networkId=" + networkId + ", serviceId=" + serviceId + ", packetFileId="
        + packetFileId + ", bpf=" + bpf + ", tuple=" + tuple + ", limit=" + limit + ", fileType="
        + fileType + "]";
  }
  ...
  public String toAuditLogText(int auditLogAction) {
    ...
    builder.append("业务ID=").append(serviceId).append("；");
    builder.append("离线文件ID=").append(packetFileId).append("；");
