...
import com.machloop.fpc.manager.appliance.vo.FilterRuleCreationVO;

/**
 * @author chenshimiao
 *
 * create at 2022/8/8 6:36 PM,cms
 * @version 1.0
 */
@Validated
@RestController
...
public class FilterRuleController {
  ...
  public Page<Map<String, Object>> queryFilterRules(
    ...
    Sort sort = new Sort(new Order(Sort.Direction.DESC, "priority"));
    ...
    filterRuleBOS.forEach(filterRuleBO -> {
      Map<String, Object> filterRuleBOTOMap = filterRuleBO2Map(filterRuleBO);
  ...
  public List<Map<String, Object>> queryFilterRules() {
    ...
    filterRuleBOS.forEach(filterRuleBO -> {
      result.add(filterRuleBO2Map(filterRuleBO));
    });
  ...
  public Map<String, Object> queryFilterRule(@PathVariable String id) {
    ...
    return filterRuleBO2Map(filterRuleBO);
  }
  ...
  private Map<String, Object> filterRuleBO2Map(FilterRuleBO filterRuleBO) {
    ...
    map.put("deleteTime", filterRuleBO.getDeleteTime());
    return map;
  }
}
