...
public class SendPolicyDaoImpl implements SendPolicyDao {
  ...
  private static final String TABLE_APPLIANCE_SEND_POLICY = "fpc_appliance_send_policy";
  ...
  @Override
  public SendPolicyDO querySendPolicyBySendPolicyInCmsId(String sendPolicyInCmsId) {
    StringBuilder sql = buildSelectStatement();
    sql.append(" where deleted = :deleted ");
    sql.append(" and send_policy_in_cms_id = :sendPolicyInCmsId ");

    Map<String, Object> params = Maps.newHashMapWithExpectedSize(Constants.MAP_DEFAULT_SIZE);
    params.put(BaseOperateDO.DELETED_FIELD, Constants.BOOL_NO);
    params.put("sendPolicyInCmsId", sendPolicyInCmsId);
  ...
  @Override
  public List<String> querySendPolicyIds(boolean onlyLocal) {
    ...
    if (onlyLocal) {
      sql.append(" and send_policy_in_cms_id = '' ");
    }
  ...
  @Override
  public List<String> queryAssignSendPolicyIds(Date beforeTime) {
    StringBuilder sql = new StringBuilder();
    sql.append("select send_policy_in_cms_id from ").append(TABLE_APPLIANCE_SEND_POLICY);
    sql.append(" where deleted = :deleted and send_policy_in_cms_id != '' ");
  ...
  public void saveSendPolicy(SendPolicyDO sendPolicyDO) {
    ...
    sql.append(" (id, name, external_receiver_id, send_rule_id, send_policy_in_cms_id, state, ");
    sql.append(" update_time, create_time, operator_id) ");
    sql.append(
        " values (:id, :name, :externalReceiverId, :sendRuleId, :sendPolicyInCmsId, :state, ");
  ...
  private StringBuilder buildSelectStatement() {
    ...
    StringBuilder sql = new StringBuilder();
    sql.append(
        " select id, name, external_receiver_id, send_rule_id, send_policy_in_cms_id, state, ");
