 ...
 */
@Repository
public class MetricPortDataRecordDaoImpl extends AbstractDataRecordDaoCkImpl
  ...
  protected String getTableName() {
    return ManagerConstants.TABLE_METRIC_PORT_DATA_RECORD;
  }
