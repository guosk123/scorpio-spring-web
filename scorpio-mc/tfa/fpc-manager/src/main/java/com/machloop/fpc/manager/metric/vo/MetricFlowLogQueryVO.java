...
public class MetricFlowLogQueryVO {
  ...
  public String toString() {
    return "MetricFlowLogQueryVO{" + "queryId='" + queryId + '\'' + ", count=" + count
        ...
        + ", endTimeDate=" + endTimeDate + ", networkId='" + networkId + '\'' + ", serviceId='"
        + serviceId + '\'' + ", interval=" + interval + ", dsl='" + dsl + '\'' + ", packetFileId='"
        + packetFileId + '\'' + ", countryId=" + countryId + ", provinceId=" + provinceId
        + ", cityId=" + cityId + ", categoryId=" + categoryId + ", subCategoryId=" + subCategoryId
        + ", applicationId=" + applicationId + ", l7ProtocolId=" + l7ProtocolId + ", port=" + port
        + ", ipProtocol='" + ipProtocol + '\'' + ", ipAddress='" + ipAddress + '\''
        + ", hostgroupId='" + hostgroupId + '\'' + ", macAddress='" + macAddress + '\''
        + ", ethernetType=" + ethernetType + ", ipLocality=" + ipLocality + ", ipLocalityInitiator="
        + ipLocalityInitiator + ", ipLocalityResponder=" + ipLocalityResponder + ", filterType='"
        + filterType + '\'' + ", columns='" + columns + '\'' + ", startTime='" + startTime + '\''
        + ", endTime='" + endTime + '\'' + ", ipInitiator='" + ipInitiator + '\''
        + ", ipResponder='" + ipResponder + '\'' + ", timePrecision=" + timePrecision
