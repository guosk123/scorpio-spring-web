...
import com.machloop.fpc.npm.analysis.vo.SuricataRuleCreationVO;
import com.machloop.fpc.npm.analysis.vo.SuricataRuleModificationVO;
...
public class SuricataRuleController {
  ...
  public void exportSuricataRules(HttpServletRequest request, HttpServletResponse response,
    ...
    try (OutputStream out = response.getOutputStream();) {
      ...
      LOGGER.warn("export suricata rules error ", e);
    }
  }
