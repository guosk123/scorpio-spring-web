 ...
 */
public class SaCustomApplicationCreationVO {
  ...
  public String toString() {
    return "SaCustomApplicationCreationVO [name=" + name + ", categoryId=" + categoryId
        + ", subCategoryId=" + subCategoryId + ", l7ProtocolId=" + l7ProtocolId + ", rule=" + rule
        + ", description=" + description + ", getName()=" + getName() + ", getCategoryId()="
        + getCategoryId() + ", getSubCategoryId()=" + getSubCategoryId() + ", getRule()="
        + getRule() + ", getDescription()=" + getDescription() + ", getClass()=" + getClass()
