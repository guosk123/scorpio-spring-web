package com.machloop.fpc.manager.metric.dao.postgres;
...
public class MetricDashboardSettingsDaoImpl implements MetricDashboardSettingsDao {
  ...
  private static final String TABLE_APPLIANCE_SERVICE_DASHBOARD_SETTINGS = "fpc_appliance_service_dashboard_settings";
