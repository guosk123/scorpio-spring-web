...
import com.machloop.fpc.manager.metric.data.*;
...
public class MetricServiceImpl implements MetricService {
  ...
  public static final Map<String,
      String> ipGraphFields = Maps.newLinkedHashMapWithExpectedSize(Constants.MAP_DEFAULT_SIZE);
  ...
  static {
    ...
    ipGraphFields.put("ipAAddress", "IP_A");
    ipGraphFields.put("ipBAddress", "IP_B");
    ipGraphFields.put("totalBytes", "总流量");
    ipGraphFields.put("establishedSessions", "会话数");
  }
  ...
  @Autowired
  private MetricForwardDataRecordDao metricForwardDao;
  ...
  /**
   * @see com.machloop.fpc.manager.metric.service.MetricService#queryMetricNetifRawdatas(java.util.Date)
   */
  @Override
  public List<Map<String, Object>> queryMetricNetifRawdatas(Date afterTime) {
    List<Map<String, Object>> result = Lists.newArrayListWithCapacity(Constants.COL_DEFAULT_SIZE);

    List<MetricNetifDataRecordDO> histogram = netifDao.queryMetricNetifs(afterTime);
  ...
  /**
   * @see com.machloop.fpc.manager.metric.service.MetricService#queryMetricNetifHistograms(com.machloop.fpc.manager.metric.vo.MetricQueryVO, java.lang.String, boolean)
   */
  @Override
  ...
  @Override
  public List<Map<String, Object>> queryMetricForwardPolicyHistograms(MetricQueryVO queryVO,
      String policyId, boolean extendedBound) {
    ForwardPolicyDO forwardPolicyDO = forwardPolicyDao.queryForwardPolicy(policyId);
    if (Integer.parseInt(forwardPolicyDO.getState()) == 0) {
      return Lists.newArrayListWithCapacity(0);
    }
    List<Map<String, Object>> result = Lists.newArrayListWithCapacity(Constants.COL_DEFAULT_SIZE);
    List<MetricForwardPolicyDataRecordDO> histogram = metricForwardDao
        .queryMetricForwardPolicyHistograms(queryVO, policyId, extendedBound);
    for (MetricForwardPolicyDataRecordDO temp : histogram) {
      Map<String, Object> item = Maps.newHashMapWithExpectedSize(Constants.MAP_DEFAULT_SIZE);
      item.put("timestamp", temp.getTimestamp());
      item.put("policyId", temp.getPolicyId());
      item.put("networkId", temp.getNetworkId());
      item.put("netifName", temp.getNetifName());

      item.put("forwardTotalBytes", temp.getForwardTotalBytes());
      item.put("forwardSuccessBytes", temp.getForwardSuccessBytes());
      item.put("forwardFailBytes", temp.getForwardFailBytes());
      item.put("forwardTotalPackets", temp.getForwardTotalPackets());
      item.put("forwardSuccessPackets", temp.getForwardSuccessPackets());
      item.put("forwardFailPackets", temp.getForwardFailPackets());
      result.add(item);
    }
    return result;
  }
  ...
  /**
   * @see com.machloop.fpc.manager.metric.service.MetricService#queryMetricLocationRawdatas(com.machloop.fpc.manager.metric.vo.MetricQueryVO)
   */
  @Override
  ...
  /**
   * @see com.machloop.fpc.manager.metric.service.MetricService#queryMetricLocations(com.machloop.fpc.manager.metric.vo.MetricQueryVO, java.lang.String, java.lang.String)
   */
  @Override
  ...
  /**
   * @see com.machloop.fpc.manager.metric.service.MetricService#queryMetricLocationHistograms(com.machloop.fpc.manager.metric.vo.MetricQueryVO, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String)
   */
  @Override
    ...
    ExportUtils.FetchData fetchData = new ExportUtils.FetchData() {
      ...
      public List<List<String>> next() {
        ...
        List<List<String>> dataSet = result.stream()
            .map(item -> metricResultMapToStr(item, titles, columnNameMap))
            .collect(Collectors.toList());
  ...
  /**
   * @see com.machloop.fpc.manager.metric.service.MetricService#queryMetricApplicationRawdatas(com.machloop.fpc.manager.metric.vo.MetricQueryVO)
   */
  @Override
  ...
  /**
   * @see com.machloop.fpc.manager.metric.service.MetricService#queryMetricApplications(com.machloop.fpc.manager.metric.vo.MetricQueryVO, java.lang.String, java.lang.String, int)
   */
  @Override
  ...
  /**
   * @see com.machloop.fpc.manager.metric.service.MetricService# queryMetricApplicationHistograms(com.machloop.fpc.manager.metric.vo.MetricQueryVO, int, java.lang.String, java.lang.String, int, java.lang.String, boolean)
   */
  @Override
  public List<Map<String, Object>> queryMetricApplicationHistograms(MetricQueryVO queryVO, int type,
    ...
    return applicationDao
        .queryMetricApplicationHistograms(queryVO, termField,
            isDetail ? ManagerConstants.METRIC_NPM_ALL_AGGSFILED : sortProperty, ids)
        .stream().map(map -> {
          switch (type) {
            case FpcConstants.METRIC_TYPE_APPLICATION_CATEGORY:
  ...
  /**
   * @see com.machloop.fpc.manager.metric.service.MetricService# countMetricApplications(com.machloop.fpc.manager.metric.vo.MetricQueryVO, java.lang.String, java.lang.String, int)
   */
  @Override
  public List<Map<String, Object>> countMetricApplications(MetricQueryVO queryVO,
    ...
    if (StringUtils.isAllBlank(queryVO.getNetworkId(), queryVO.getServiceId(),
        queryVO.getPacketFileId())) {
      networkIds = networkService.queryNetworks().stream().map(NetworkBO::getId)
          .collect(Collectors.toList());
  ...
  /**
   * @see com.machloop.fpc.manager.metric.service.MetricService#queryMetricL7ProtocolRawdatas(com.machloop.fpc.manager.metric.vo.MetricQueryVO)
   */
  @Override
  ...
  /**
   * @see com.machloop.fpc.manager.metric.service.MetricService#queryMetricL7Protocols(com.machloop.fpc.manager.metric.vo.MetricQueryVO, java.lang.String, java.lang.String)
   */
  @Override
  ...
  /**
   * @see com.machloop.fpc.manager.metric.service.MetricService# queryMetricL7ProtocolHistograms(com.machloop.fpc.manager.metric.vo.MetricQueryVO, java.lang.String, java.lang.String, int, java.lang.String)
   */
  @Override
  ...
  /**
   * @see com.machloop.fpc.manager.metric.service.MetricService# countMetricL7Protocols(com.machloop.fpc.manager.metric.vo.MetricQueryVO, java.lang.String, java.lang.String, int)
   */
  @Override
  ...
  /**
   * @see com.machloop.fpc.manager.metric.service.MetricService#queryMetricPortRawdatas(com.machloop.fpc.manager.metric.vo.MetricQueryVO)
   */
  @Override
  ...
  /**
   * @see com.machloop.fpc.manager.metric.service.MetricService#queryMetricPorts(com.machloop.fpc.manager.metric.vo.MetricQueryVO, java.lang.String, java.lang.String)
   */
  @Override
  ...
  /**
   * @see com.machloop.fpc.manager.metric.service.MetricService# queryMetricPortHistograms(com.machloop.fpc.manager.metric.vo.MetricQueryVO, java.lang.String, java.lang.String, int, java.lang.String)
   */
  @Override
  ...
  /**
   * @see com.machloop.fpc.manager.metric.service.MetricService#queryMetricHostGroupRawdatas(com.machloop.fpc.manager.metric.vo.MetricQueryVO)
   */
  @Override
  ...
  /**
   * @see com.machloop.fpc.manager.metric.service.MetricService#queryMetricHostGroups(com.machloop.fpc.manager.metric.vo.MetricQueryVO, java.lang.String, java.lang.String)
   */
  @Override
  ...
  /**
   * @see com.machloop.fpc.manager.metric.service.MetricService# queryMetricHostGroupHistograms(com.machloop.fpc.manager.metric.vo.MetricQueryVO, java.lang.String, java.lang.String, int, java.lang.String)
   */
  @Override
  ...
  /**
   * @see com.machloop.fpc.manager.metric.service.MetricService#queryMetricL2DeviceRawdatas(com.machloop.fpc.manager.metric.vo.MetricQueryVO)
   */
  @Override
  ...
  /**
   * @see com.machloop.fpc.manager.metric.service.MetricService#queryMetricL2Devices(com.machloop.fpc.manager.metric.vo.MetricQueryVO, java.lang.String, java.lang.String)
   */
  @Override
  ...
  /**
   * @see com.machloop.fpc.manager.metric.service.MetricService# queryMetricL2DeviceHistograms(java.util.Date, java.util.Date, int, java.lang.String)
   */
  @Override
   ...
   */
  /**
   * @see com.machloop.fpc.manager.metric.service.MetricService#queryMetricL3DeviceRawdatas(com.machloop.fpc.manager.metric.vo.MetricQueryVO)
   */
  @Override
  ...
  /**
   * @see com.machloop.fpc.manager.metric.service.MetricService#queryMetricL3Devices(com.machloop.fpc.manager.metric.vo.MetricQueryVO, java.lang.String, java.lang.String)
   */
  @Override
  ...
  /**
   * @see com.machloop.fpc.manager.metric.service.MetricService# queryMetricL3DeviceHistograms(com.machloop.fpc.manager.metric.vo.MetricQueryVO, java.lang.String, java.lang.String, int, java.lang.String, java.lang.String)
   */
  @Override
  ...
  /**
   * @see com.machloop.fpc.manager.metric.service.MetricService# countMetricL3Devices(com.machloop.fpc.manager.metric.vo.MetricQueryVO, java.lang.String, java.lang.String, int)
   */
  @Override
  public List<Map<String, Object>> countMetricL3Devices(MetricQueryVO queryVO, String sortProperty,
    ...
    if (StringUtils.isBlank(compareProperty)) {
      ...
      result = l3DeviceDao
          .countMetricL3Devices(queryVO, sortProperty, sortProperty, sortDirection, networkIds)
          .stream()
   ...
   */
  /**
   * @see com.machloop.fpc.manager.metric.service.MetricService#queryMetricIpConversationRawdatas(com.machloop.fpc.manager.metric.vo.MetricQueryVO)
   */
  @Override
  ...
  /**
   * @see com.machloop.fpc.manager.metric.service.MetricService#queryMetricIpConversations(com.machloop.fpc.manager.metric.vo.MetricQueryVO, java.lang.String, java.lang.String)
   */
  @Override
  ...
  /**
   * @see com.machloop.fpc.manager.metric.service.MetricService# queryMetricIpConversationHistograms(com.machloop.fpc.manager.metric.vo.MetricQueryVO, java.lang.String, java.lang.String, int, java.lang.String, java.lang.String)
   */
  @Override
  ...
  /**
   * @see com.machloop.fpc.manager.metric.service.MetricService# countMetricIpConversations(com.machloop.fpc.manager.metric.vo.MetricQueryVO, java.lang.String, java.lang.String, int)
   */
  @Override
  ...
  /**
   * @see com.machloop.fpc.manager.metric.service.MetricService#graphMetricIpConversations(com.machloop.fpc.manager.metric.vo.MetricQueryVO, java.lang.Integer, java.lang.Integer, java.lang.String, java.lang.String)
   */
  @Override
  ...
  /**
   * @see com.machloop.fpc.manager.metric.service.MetricService#exportGraphMetricIpConversations(javax.servlet.ServletOutputStream, com.machloop.fpc.manager.metric.vo.MetricQueryVO, java.lang.String, java.lang.String, java.lang.String, java.lang.Integer, java.lang.Integer)
   */
  @Override
  public void exportGraphMetricIpConversations(ServletOutputStream outputStream,
    ...
    if (StringUtils.equals(queryVO.getDrilldown(), Constants.BOOL_YES)) {
      result = metricFlowlogService.graphMetricIpConversations(queryVO, minEstablishedSessions,
          minTotalBytes, Constants.BOOL_NO, sortProperty, sortDirection);
    } else {
  ...
  private void exportAsExcel(List<Map<String, Object>> result, MetricQueryVO queryVO,
    ...
    List<String> titles = Lists.newArrayListWithCapacity(Constants.COL_DEFAULT_SIZE);
    titles.addAll(ipGraphFields.values());
    ...
    Map<String, String> columnNameMap = ipGraphFields.entrySet().stream()
   ...
   */
  /**
   * @see com.machloop.fpc.manager.metric.service.MetricService#queryMetricDhcpRawdatas(com.machloop.fpc.manager.metric.vo.MetricQueryVO)
   */
  @Override
  ...
  /**
   * @see com.machloop.fpc.manager.metric.service.MetricService#queryMetricDhcps(com.machloop.fpc.manager.metric.vo.MetricQueryVO, java.lang.String, java.lang.String, java.lang.String)
   */
  @Override
  ...
  /**
   * @see com.machloop.fpc.manager.metric.service.MetricService# queryMetricDhcpHistograms(com.machloop.fpc.manager.metric.vo.MetricQueryVO, java.lang.String, java.lang.String, java.lang.String, int, java.lang.String)
   */
  @Override
   ...
   */
  /**
   * @see com.machloop.fpc.manager.metric.service.MetricService#queryMetricDscps(com.machloop.fpc.manager.metric.vo.MetricQueryVO, java.lang.String, java.lang.String)
   */
  @Override
  ...
  /**
   * @see com.machloop.fpc.manager.metric.service.MetricService# queryMetricDscpHistograms(com.machloop.fpc.manager.metric.vo.MetricQueryVO, java.lang.String, java.lang.String, int)
   */
  @Override
  ...
  /**
   * @see com.machloop.fpc.manager.metric.service.MetricService#queryMetricHttps(com.machloop.fpc.manager.metric.vo.MetricQueryVO, java.lang.String, java.lang.String)
   */
  @Override
  ...
  private List<String> metricResultMapToStr(Map<String, Object> metricResult, List<String> titles,
