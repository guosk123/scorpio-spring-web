...
import com.machloop.fpc.npm.appliance.dao.NetworkTopologyDao;
...
public class NetworkTopologyDaoImpl implements NetworkTopologyDao {
  ...
  private static final String TABLE_APPLIANCE_NETWORK_TOPOLOGY = "fpc_appliance_network_topology";

  @Autowired
  private NamedParameterJdbcTemplate jdbcTemplate;

  /**
   * @see com.machloop.fpc.npm.appliance.dao.NetworkTopologyDao#queryNetworkTopology()
   */
  @Override
  ...
  /**
   * @see com.machloop.fpc.npm.appliance.dao.NetworkTopologyDao#queryNetworkTopologyByNetworkId(java.lang.String)
   */
  @Override
  ...
  /**
   * @see com.machloop.fpc.npm.appliance.dao.NetworkTopologyDao#saveOrUpdateNetworkTopology(com.machloop.fpc.npm.appliance.data.NetworkTopologyDO)
   */
  @Override
