...
VALUES
('1', 'PERM_USER', '普通用户权限', '具有普通用户权限，可以使用除系统管理之外的产品功能。', 0, NOW(), NOW(), NULL, ''),
('2', 'PERM_SYS_USER', '系统管理权限', '具有系统管理权限，可以使用系统管理相关功能。', 0, NOW(), NOW(), NULL, ''),
('3', 'PERM_AUDIT_USER', '审计管理权限', '具有审计管理权限，可以使用日志审计管理相关功能。', 0, NOW(), NOW(), NULL, ''),
('4', 'PERM_RESTAPI_USER', 'RESTAPI调用权限', '具有RESTAPI调用权限，可以使用RESTAPI相关功能。', 0, NOW(), NOW(), NULL, '');

INSERT INTO public.alpha_system_role
(id, name_en, name_zh, description, deleted, create_time, update_time, delete_time, operator_id)
VALUES
('1', 'ROLE_USER', '普通用户角色', '具有普通用户权限的角色。', 0, NOW(), NOW(), NULL, ''),
('2', 'ROLE_SYS_USER', '系统管理角色', '具有系统管理权限的角色。', 0, NOW(), NOW(), NULL, ''),
('3', 'ROLE_AUDIT_USER', '审计管理角色', '具有审计管理权限的角色。', 0, NOW(), NOW(), NULL, ''),
('4', 'ROLE_RESTAPI_USER', 'RESTAPI调用角色', '具有RESTAPI调用权限的角色。', 0, NOW(), NOW(), NULL, '');
...
('8', 'cms.token', '', NOW()),
('9', 'cms.state', '0', NOW()),
('10', 'data-record.rollup.latest.5min', '', NOW()),
('11', 'data-record.rollup.latest.1hour', '', NOW()),
('12', 'data-record.clean.latest.time', '', NOW()),
('13', 'total.flow.log.volume', '0', NOW()),
('14', 'analysis.threat.intelligence.version', '0', NOW()),
('15', 'analysis.standard.protocol.version', '0', NOW()),
('16', 'sa.custom.category.next.id', '101', NOW()),
('17', 'sa.custom.subcategory.next.id', '101', NOW()),
('18', 'sa.custom.application.next.id', '50001', NOW()),
('19', 'system.syslog.sendup.latest.time', '', NOW()),
('20', 'metric.setting.server.response.normal', '100', NOW()),
('21', 'metric.setting.server.response.timeout', '400', NOW()),
('22', 'metric.setting.long.connection', '3600', NOW()),
('23', 'geoip.custom.country.next.id', '300', NOW()),
('24', 'local.device.id', '',NOW()),
('25', 'local.device.name', '',NOW()),
('26', 'local.last.heartbeat', '', NOW()),
('27', 'sendup.alarm.cursor', '0', NOW()),
('28', 'sendup.log.cursor', '0', NOW());
...
('3', '硬盘剩余空间', '2', 'DISK', '[{"metric":"fs_system_free","operator":"<","operand":4000,"operand_unit":"mb"},{"metric":"fs_index_free","operator":"<","operand":50000,"operand_unit":"mb"},{"metric":"fs_metadata_free","operator":"<","operand":10000,"operand_unit":"mb"}]', 3600, '1', NOW(), '1'),
('4', 'IO速率', '2', 'IO', '[{"metric":"fs_system_io","operator":">","operand":10000,"operand_unit":"mbps"},{"metric":"fs_index_io","operator":">","operand":10000,"operand_unit":"mbps"},{"metric":"fs_metadata_io","operator":">","operand":10000,"operand_unit":"mbps"},{"metric":"fs_packet_io","operator":">","operand":10000,"operand_unit":"mbps"}]', 300, '0', NOW(), '1');

-- ----------------------------
-- Table initial data for fpc
-- ----------------------------

INSERT INTO public.fpc_system_device_netif
(id, name, state, category, description, deleted, create_time, update_time, delete_time, operator_id)
VALUES 
('1', 'eth0', 1, 0, '', 0, NOW(), NOW(), NULL, '');

INSERT INTO public.fpc_appliance_ingest_policy
(id, name, default_action, except_bpf, except_tuple, deduplication, description, deleted, create_time, update_time, delete_time, operator_id)
VALUES
('1', '默认规则', 0, '', '', 1, '', 0, NOW(), NOW(), NULL, '');

INSERT INTO public.fpc_appliance_storage_policy
(id, compress_action, encrypt_action, encrypt_algorithm, deleted, create_time, update_time, delete_time, operator_id)
VALUES
('1', 0, 1, '', 0, NOW(), NOW(), NULL, '');

INSERT INTO public.fpc_appliance_filter_policy
(id, name, default_action, except_application, except_flow, description, deleted, create_time, update_time, delete_time, operator_id)
VALUES
('1', '默认规则', 0, '', 1, '', 0, NOW(), NOW(), NULL, '');

INSERT INTO public.fpc_appliance_storage_filter_rule
(id, name, tuple, storage_rule_in_cms_id, state, priority, description, deleted, create_time, update_time, delete_time, operator_id)
VALUES
('1', '缺省策略', '[{"action":"store"}]', '', 1, 0,  '缺省策略,应用于所有网络',  0, NOW(), NOW(), NULL,'');

INSERT INTO public.fpc_analysis_standard_protocol
(id, l7_protocol_id, ip_protocol, port, source, description, deleted, create_time, update_time, delete_time, operator_id)
VALUES
('1', '1', 'tcp', '80', '0', '', 0, NOW(), NOW(), NULL, ''),
('2', '1', 'tcp', '8080', '0', '', 0, NOW(), NOW(), NULL, ''),
('3', '12', 'tcp', '443', '0', '', 0, NOW(), NOW(), NULL, ''),
('4', '12', 'tcp', '8443', '0', '', 0, NOW(), NOW(), NULL, ''),
('5', '2', 'tcp', '53', '0', '', 0, NOW(), NOW(), NULL, ''),
('6', '2', 'udp', '53', '0', '', 0, NOW(), NOW(), NULL, ''),
('7', '3', 'tcp', '25', '0', '', 0, NOW(), NOW(), NULL, ''),
('8', '4', 'tcp', '110', '0', '', 0, NOW(), NOW(), NULL, ''),
('9', '5', 'tcp', '143', '0', '', 0, NOW(), NOW(), NULL, ''),
('10', '6', 'tcp', '21', '0', '', 0, NOW(), NOW(), NULL, ''),
('11', '7', 'tcp', '23', '0', '', 0, NOW(), NOW(), NULL, '');

INSERT INTO public.fpc_analysis_suricata_rule_classtype
...
INSERT INTO public.fpc_analysis_mitre_attack 
(id, name, parent_id) 
VALUES 
('0', '其他', ''),
('TA0001', '初始访问', ''),
...
INSERT INTO public.fpc_analysis_suricata_rule
...
INSERT INTO public.fpc_appliance_asset_device 
(id, device_name, update_time, operator_id)
VALUES
(0, '终端', now(), ''),
(1, '服务器', now(), ''),
(2, '网络打印机', now(), ''),
...
INSERT INTO public.fpc_appliance_asset_os 
(id, os, update_time, operator_id)
VALUES
(1, 'Linux', now(), ''),
(2, 'Windows', now(), ''),
(3, 'Mac OS X', now(), ''),
...
INSERT INTO public.fpc_appliance_nat_config
(id, nat_action, update_time, operator_id)
VALUES
('1',0,NOW(),'');