CREATE TABLE IF NOT EXISTS fpc.t_fpc_metric_ip_conversation_data_record
( 
...
INDEX i_ip_a_address (ip_a_address) TYPE bloom_filter() GRANULARITY 4, 
INDEX i_ip_b_address (ip_b_address) TYPE bloom_filter() GRANULARITY 4, 
