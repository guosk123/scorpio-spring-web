CREATE TABLE IF NOT EXISTS fpc.t_fpc_protocol_ftp_log_record
( 
...
INDEX i_user (user) TYPE bloom_filter() GRANULARITY 4,
INDEX i_filename (filename) TYPE bloom_filter() GRANULARITY 4,
INDEX i_data_channel_ip (data_channel_ip) TYPE minmax GRANULARITY 4,
INDEX i_data_channel_port (data_channel_port) TYPE minmax GRANULARITY 4
)  
ENGINE = MergeTree() 
