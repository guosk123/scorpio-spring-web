CREATE TABLE IF NOT EXISTS fpc.t_fpc_protocol_icmp_log_record
(
...
INDEX i_version (version) TYPE minmax GRANULARITY 4,
INDEX i_request_data_len (request_data_len) TYPE minmax GRANULARITY 4,
INDEX i_response_data_len (response_data_len) TYPE minmax GRANULARITY 4,
INDEX i_only_request (only_request) TYPE minmax GRANULARITY 4,
INDEX i_only_response (only_response) TYPE minmax GRANULARITY 4
) 
ENGINE = MergeTree()
