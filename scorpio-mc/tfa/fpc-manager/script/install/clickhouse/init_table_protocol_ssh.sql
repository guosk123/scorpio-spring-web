CREATE TABLE IF NOT EXISTS fpc.t_fpc_protocol_ssh_log_record
(
...
INDEX i_client_version (client_version) TYPE bloom_filter() GRANULARITY 4,
INDEX i_client_software (client_software) TYPE bloom_filter() GRANULARITY 4,
INDEX i_server_version (server_version) TYPE bloom_filter() GRANULARITY 4,
INDEX i_server_software (server_software) TYPE bloom_filter() GRANULARITY 4,
INDEX i_server_key_type (server_key_type) TYPE bloom_filter() GRANULARITY 4,
INDEX i_server_key (server_key) TYPE bloom_filter() GRANULARITY 4
) 
ENGINE = MergeTree()
