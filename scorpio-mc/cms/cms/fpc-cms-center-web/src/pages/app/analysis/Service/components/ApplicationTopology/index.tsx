...
import { ESourceType, IUriParams } from '../../../typings';
import { getBytepsAvg, getTcpEstablishedSuccessRate } from '../../List';
import styles from './index.less';
import { ENetowrkType, INetworkTreeItem } from '@/pages/app/Network/typing';
...
const Topology: React.FC<ITopology> = ({
  ...
  const [networkType] = useContext<[ENetowrkType, INetworkTreeItem[], any[]]>(ServiceContext);
  ...
  useEffect(() => {
    const dsl = `${
      networkType === ENetowrkType.NETWORK
        ? `(${`network_id=${interNetworkId} AND service_id=${interServiceId}`})`
        : ``
