...
export default function TransmitRules() {
      ...
      render: (_: any, record: any) => (
        <>
          <Button
            ...
            size="small"
            onClick={() => {
              history.push(`/configuration/transmit/sendup-rules/${record?.id}/update`);
            }}
          >
            编辑
          </Button>
  ...
  return (
    <>
      <div style={{ marginBottom: 10, textAlign: 'right' }}>
        <Space>
          ...
          <Button
            ...
            icon={<PlusOutlined />}
            onClick={() => {
              history.push('/configuration/transmit/sendup-rules/create');
            }}
          >
            新建
          </Button>
      ...
      <Table loading={loading} size="small" pagination={false} bordered columns={columns} dataSource={tableData} />
    </>
  );
}
