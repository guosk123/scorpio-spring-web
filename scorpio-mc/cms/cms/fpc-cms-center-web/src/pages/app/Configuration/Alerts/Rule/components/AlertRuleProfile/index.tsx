...
import { INetworkSensor } from '@/pages/app/Configuration/Network/typings';
...
const AlertRuleProfile = (props: IAlertRuleProfileProps) => {
  ...
  const networkAndServiceList = useMemo(() => {
    const tmpNetwork = networkSensorTree.concat(
  ...
  }, [allLogicalSubnets, allServices, networkSensorTree]);
