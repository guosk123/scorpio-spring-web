...
import type { IServiceListRes } from '../../appliance/hooks/useServiceList';
 ...
 * 不分页的业务列表
 */
export async function queryServiceList(): Promise<IAjaxResponseFactory<IServiceListRes[]>>  {
  return ajax(`${API_VERSION_PRODUCT_V1}/appliance/services/all`)
}
