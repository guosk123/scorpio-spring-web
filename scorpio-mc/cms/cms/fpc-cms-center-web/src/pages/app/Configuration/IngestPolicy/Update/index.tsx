...
class UpdateIngestPolicy extends React.PureComponent<IUpdateIngestPolicyProps> {
  componentDidMount() {
    const {
      params: { policyId },
    } = this.props.match;
  ...
  render() {
    ...
    return <IngestPolicyForm detail={ingestPolicyDeatil} />;
  }
}
