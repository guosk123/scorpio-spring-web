...
import type { INetworkSensorMap } from '../../Network/typings';
      ...
      render: (networkIds: any) => {
        return networkIds === 'allNetwork'
          ...
          : networkIds
              ...
              .map((networkId: any) => {
                return (
                  { ...allNetworkSensorMap, ...allLogicalSubnetMap }[networkId]?.name || networkId
                );
              })
              .join(',');
      },
...
export default connect(
  ({
    networkModel: { allNetworkSensorMap, networkSensorTree },
