      ...
      content: (
        <Fragment>
          ...
          <CustomTemplatSliceGroup
            title=""
            categories={[]}
            data={timeSliceArray.map((item) => +item)}
          />
        </Fragment>
      ),
    });
          ...
          return (
            <Fragment>
              ...
              {dataSource === 'flow-log-record' && (
                <Link to={getLinkUrl(`/detection/scenario-task/result/flow-record?${queryParms}`)}>
                  详情
                </Link>
              )}
              ...
              {dataSource === 'http' && (
                <Link
                  to={getLinkUrl(`/detection/scenario-task/result/metadata-http?${queryParms}`)}
                >
                  详情
                </Link>
              )}
              ...
              {dataSource === 'dns' && (
                <Link to={getLinkUrl(`/detection/scenario-task/result/metadata-dns?${queryParms}`)}>
                  详情
                </Link>
              )}

              {dataSource === 'ftp' && (
                <Link to={getLinkUrl(`/detection/scenario-task/result/metadata-ftp?${queryParms}`)}>
                  详情
                </Link>
              )}
              ...
              {dataSource === 'mail' && (
                <Link
                  to={getLinkUrl(`/detection/scenario-task/result/metadata-mail?${queryParms}`)}
                >
                  详情
                </Link>
              )}
              ...
              {dataSource === 'telnet' && (
                <Link
                  to={getLinkUrl(`/detection/scenario-task/result/metadata-telnet?${queryParms}`)}
                >
                  详情
                </Link>
              )}
              ...
              {dataSource === 'ssl' && (
                <Link to={getLinkUrl(`/detection/scenario-task/result/metadata-ssl?${queryParms}`)}>
                  详情
                </Link>
              )}
