...
const PktAnalysis: React.FC<IPktAnalysisProps> = (props) => {
  ...
  const queryParams = useMemo(() => {
    return { sourceType, taskId, packetFilterJson, ...sensorNetworkInfo };
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [sensorNetworkInfo, sourceType, taskId]);
  // 被选中的某一行帧的数据
  ...
  const statFollowFilter = (currentTap: ICustomStatTapData) => {
    ...
    const target = decodeTree.fol.find((el) => el && el[0] === currentTap.follow);
      ...
      <div style={{ height: paneHeight }} className={styles.wrapper}>
              ...
              {queryPacketInfoLoading ? (
                ...
                <>
                  ...
                  <span
                    ...
                    style={showBackBtn ? {} : { display: 'none' }}
        ...
        <div style={{ height: 'calc(100% - 80px)' }} className={styles.splitWrap}>
          ...
          <SplitPane
            ...
            style={{ height: '100%' }}
          >
            <Pane maxSize="1000px" initialSize={frameListHeight} minSize="200px">
              <FrameList
