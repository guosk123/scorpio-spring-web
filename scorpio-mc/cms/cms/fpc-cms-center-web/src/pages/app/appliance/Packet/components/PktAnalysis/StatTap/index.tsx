...
import { ascii2Char, xtoa } from '../Hexdump';
import type {
  IConvsTapData,
...
class StatTap extends React.PureComponent<StatTapProps, StatTapStates> {
  ...
  renderRtpStreamTap = (tap: IRtpStreamTapResponseData) => {
    ...
    for (let i = 0; i < streams.length; i += 1) {
      ...
      const rtp_str = `${stream.saddr}_${stream.sport}_${stream.daddr}_${stream.dport}_${xtoa(
        stream.ssrc,
        0,
      )}`;
  ...
  handleDownloadObject = (object: IExportObjectData) => {
    const { sourceType, taskId, dispatch, ...props } = this.props;
              ...
              footer={
                <div className={styles.modalFooter}>
                  <div className={styles.baseSelect}>
                    ...
                    >
                      <Select.Option key={EDataBase['UTF-8']} value={EDataBase['UTF-8']}>
                        UTF-8
                      </Select.Option>
                      <Select.Option key={EDataBase.GB2312} value={EDataBase.GB2312}>
                        GB2312
                      </Select.Option>
                      <Select.Option key={EDataBase.ASCII} value={EDataBase.ASCII}>
                        ASCII
                      </Select.Option>
                      <Select.Option key={EDataBase['UTF-16']} value={EDataBase['UTF-16']}>
                        UTF-16
                      </Select.Option>
                      <Select.Option key={EDataBase['UTF-32']} value={EDataBase['UTF-32']}>
                        UTF-32
                      </Select.Option>
                      <Select.Option key={EDataBase['UTF-16BE']} value={EDataBase['UTF-16BE']}>
                        UTF-16BE
                      </Select.Option>
                      <Select.Option key={EDataBase['UTF-16LE']} value={EDataBase['UTF-16LE']}>
                        UTF-16LE
                      </Select.Option>
                      <Select.Option key={EDataBase.URLDECODE} value={EDataBase.URLDECODE}>
                        URLDECODE
                      </Select.Option>
                      <Select.Option key={EDataBase.HEX} value={EDataBase.HEX}>
                        HEX
                      </Select.Option>
                    </Select>
                  </div>
