...
import useDomainNameTable from '../hooks/useDomainNameDataTable';
import useAlarmTable from '../hooks/useAlarmDataTable';
...
export default function MoreInformation(props: IMoreInformationProps) {
  ...
  const { category, selectedTime, querydata, queryTotalNumber } = props;
  ...
  const queryParams = useMemo(() => {
    return {
      ...
      ...queryProperty,
      ...networkParams,
      dsl: `| gentimes report_time start="${selectedTime.startTime}" end="${selectedTime.endTime}"`,
      // drilldown: BOOL_NO,
      // queryId: uuidv1(),
    };
  }, [networkParams, selectedTime, queryTypeParams, queryIpLocalityTypeParams, queryProperty]);
