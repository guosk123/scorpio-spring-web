...
export async function queryMonitorMetrics(params) {
  return ajax(
    `${config.API_VERSION_PRODUCT_V1}/system/monitor-metrics/as-histogram${
...
export async function queryFlowProtocolHistogram(params) {
  return ajax(
    `${config.API_VERSION_PRODUCT_V1}/metadata/flows/as-histogram${
      params && `?${stringify(params)}`
    }`,
  );
}
...
export async function countFlowProtocol(params) {
  return ajax(
    `${config.API_VERSION_PRODUCT_V1}/metadata/flow-logs/as-protocol-count${
      params && `?${stringify(params)}`
    }`,
  );
}
...
export async function queryProbeMetricsHistogram(params) {
  return ajax(
    `${config.API_VERSION_PRODUCT_V1}/metadata/probe-metrics/as-histogram${
      params && `?${stringify(params)}`
    }`,
  );
}
...
export async function queryNetifMetricsHistogram(params) {
  return ajax(
    `${config.API_VERSION_PRODUCT_V1}/metadata/netif-metrics/as-histogram${
      params && `?${stringify(params)}`
    }`,
  );
}
