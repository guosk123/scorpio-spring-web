DROP TABLE IF EXISTS fpc.d_fpc_protocol_tns_log_record;
CREATE TABLE IF NOT EXISTS fpc.d_fpc_protocol_tns_log_record
(
...
ENGINE = Distributed(clickhouse_servers, fpc, t_fpc_protocol_tns_log_record)
