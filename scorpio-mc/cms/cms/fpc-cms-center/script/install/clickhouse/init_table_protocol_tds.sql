DROP TABLE IF EXISTS fpc.d_fpc_protocol_tds_log_record;
CREATE TABLE IF NOT EXISTS fpc.d_fpc_protocol_tds_log_record
(
...
ENGINE = Distributed(clickhouse_servers, fpc, t_fpc_protocol_tds_log_record)
COMMENT '应用层协议详单-TDS协议详单表';