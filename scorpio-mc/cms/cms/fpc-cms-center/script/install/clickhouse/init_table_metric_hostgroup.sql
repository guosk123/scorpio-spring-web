DROP TABLE IF EXISTS fpc.d_fpc_metric_hostgroup_data_record;
CREATE TABLE IF NOT EXISTS fpc.d_fpc_metric_hostgroup_data_record
( 
`timestamp` DateTime64(3, 'UTC') COMMENT '时间',
`network_id` String COMMENT '网络ID',
`service_id` String COMMENT '业务ID',
`hostgroup_id` String COMMENT '地址组ID',
...
ENGINE = Distributed(ch_stats_servers, fpc, t_fpc_metric_hostgroup_data_record)
COMMENT 'IP地址组统计表';