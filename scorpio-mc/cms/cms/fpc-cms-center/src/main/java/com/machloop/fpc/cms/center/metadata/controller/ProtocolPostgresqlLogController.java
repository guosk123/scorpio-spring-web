...
import com.machloop.fpc.cms.center.metadata.vo.ProtocolPostgresqlLogVO;
...
public class ProtocolPostgresqlLogController {

  private static final Logger LOGGER = LoggerFactory
      .getLogger(ProtocolPostgresqlLogController.class);

  @Autowired
  @Qualifier("protocolPostgresqlLogService")
  private LogRecordService<ProtocolPostgresqlLogVO> logRecordService;

  @GetMapping("/protocol-postgresql-logs")
  @Secured({"PERM_USER"})
  public Page<ProtocolPostgresqlLogVO> queryLogRecords(
  ...
  @GetMapping("/protocol-postgresql-logs/as-statistics")
  @Secured({"PERM_USER"})
  ...
  @GetMapping("/protocol-postgresql-logs/via-dsl")
  @Secured({"PERM_USER"})
  public String queryLogRecordViaDsl(@RequestParam String dsl) {
    return logRecordService.queryLogRecordsViaDsl(dsl);
  }

  @GetMapping("/protocol-postgresql-logs/{id}")
  @Secured({"PERM_USER"})
  public ProtocolPostgresqlLogVO queryLogRecord(@PathVariable String id, LogRecordQueryVO queryVO) {

    return logRecordService.queryLogRecord(queryVO, id);
  }

  @GetMapping("/protocol-postgresql-logs/as-export")
  @Secured({"PERM_USER"})
  public void exportLogRecords(@RequestParam(required = false, defaultValue = "") String startTime,
    ...
    try (OutputStream out = response.getOutputStream();) {
      ...
      LOGGER.warn("export postgresql logs error ", e);
    }
  }
}
