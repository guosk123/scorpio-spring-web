...
public class AlertScopeDaoImpl implements AlertScopeDao {
  ...
  /**
   * @see com.machloop.fpc.cms.center.appliance.dao.AlertScopeDao#queryAlertScope()
   */
  @Override
  ...
  /**
   * @see com.machloop.fpc.cms.center.appliance.dao.AlertScopeDao#queryAlertScope(java.lang.String, java.lang.String, java.lang.String)
   */
  @Override
  ...
  /**
   * @see com.machloop.fpc.cms.center.appliance.dao.AlertScopeDao#queryAlertScopeByAlertId(java.lang.String)
   */
  @Override
  ...
  /**
   * @see com.machloop.fpc.cms.center.appliance.dao.AlertScopeDao#batchSaveAlertScopes(java.util.List)
   */
  @Override
  ...
  /**
   * @see com.machloop.fpc.cms.center.appliance.dao.AlertScopeDao#batchUpdateAlertScopes(java.lang.String, java.util.List)
   */
  @Override
  ...
  /**
   * @see com.machloop.fpc.cms.center.appliance.dao.AlertScopeDao#deleteAlertScopeByAlertId(java.lang.String)
   */
  @Override
  ...
  /**
   * @see com.machloop.fpc.cms.center.appliance.dao.AlertScopeDao#deleteAlertScope(java.lang.String, java.lang.String, java.lang.String)
   */
  @Override
  public int deleteAlertScope(String alertId, String networkId, String serviceId) {
    StringBuilder sql = new StringBuilder();
    sql.append("delete from ").append(TABLE_APPLIANCE_ALERT_SCOPE);
    sql.append(" where alert_id = :alertId ");
