...
public class ServiceBO implements LogAudit {
  ...
  public String toString() {
    return "ServiceBO [id=" + id + ", assignId=" + assignId + ", name=" + name + ", networkIds="
        + networkIds + ", application=" + application + ", description=" + description
        + ", createTime=" + createTime + ", networkNames=" + networkNames + ", networkGroupIds="
        + networkGroupIds + ", networkGroupNames=" + networkGroupNames + "]";
  }
