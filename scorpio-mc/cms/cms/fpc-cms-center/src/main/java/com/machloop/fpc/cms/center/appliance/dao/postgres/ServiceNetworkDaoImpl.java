...
public class ServiceNetworkDaoImpl implements ServiceNetworkDao {
  ...
  private static final String TABLE_APPLIANCE_SERVICE_NETWORK = "fpccms_appliance_service_network";

  @Autowired
  private NamedParameterJdbcTemplate jdbcTemplate;

  /**
   * @see com.machloop.fpc.cms.center.appliance.dao.ServiceNetworkDao#queryServiceNetworks()
   */
  @Override
  public List<ServiceNetworkDO> queryServiceNetworks() {
    StringBuilder sql = new StringBuilder();
    sql.append("select id, service_id, network_id, network_group_id ");
  ...
  /**
   * @see com.machloop.fpc.cms.center.appliance.dao.ServiceNetworkDao#queryServiceNetworks(java.util.List)
   */
  @Override
  ...
  /**
   * @see com.machloop.fpc.cms.center.appliance.dao.ServiceNetworkDao#queryServiceNetworks(java.lang.String, java.lang.String)
   */
  @Override
  ...
  /**
   * @see com.machloop.fpc.cms.center.appliance.dao.ServiceNetworkDao#queryExistServiceNetworkList(java.lang.String, java.lang.String)
   */
  @Override
  public List<ServiceNetworkDO> queryExistServiceNetworkList(String serviceId,
  ...
  /**
   * @see com.machloop.fpc.cms.center.appliance.dao.ServiceNetworkDao#queryServiceNetworkByNetworkGroupId(java.lang.String)
   */
  @Override
  public List<ServiceNetworkDO> queryServiceNetworkByNetworkGroupId(String networkGroupId) {
    StringBuilder sql = new StringBuilder();
    sql.append("select id, service_id, network_group_id ");
    sql.append(" from ").append(TABLE_APPLIANCE_SERVICE_NETWORK);
    sql.append(" where 1=1 ");
  ...
  /**
   * @see com.machloop.fpc.cms.center.appliance.dao.ServiceNetworkDao#mergeServiceNetworks(java.util.List)
   */
  @Override
  ...
  /**
   * @see com.machloop.fpc.cms.center.appliance.dao.ServiceNetworkDao#batchSaveServiceNetwork(java.util.List)
   */
  @Override
  public void batchSaveServiceNetwork(List<ServiceNetworkDO> serviceNetworks) {
    ...
    sql.append(" (id, service_id, network_id, network_group_id) ");
    sql.append(" values (:id, :serviceId, :networkId, :networkGroupId) ");
  ...
  /**
   * @see com.machloop.fpc.cms.center.appliance.dao.ServiceNetworkDao#deleteServiceNetwork(java.lang.String)
   */
  @Override
