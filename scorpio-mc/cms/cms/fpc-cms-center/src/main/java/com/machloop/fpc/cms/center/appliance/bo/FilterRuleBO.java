 ...
 * @author chenshimiao
 * <p>
 * create at 2022/8/18 10:55 AM,cms
 * @version 1.0
 */
public class FilterRuleBO implements LogAudit {
  ...
  private List<String> networkGroupId;
  private Integer priority;

  @Override
  public String toString() {
    return "FilterRuleBO [id=" + id + ", assignId" + assignId + ", name=" + name + ", tuple="
        + tuple + ", state=" + state + ", description=" + description + ", createTime=" + createTime
        + ", updateTime=" + updateTime + ", deletedTime=" + deletedTime + ", networkId=" + networkId
        + ", networkGroupId=" + networkGroupId + ", priority" + priority + "]";
  }
  ...
  public List<String> getNetworkGroupId() {
    return networkGroupId;
  }

  public void setNetworkGroupId(List<String> networkGroupId) {
