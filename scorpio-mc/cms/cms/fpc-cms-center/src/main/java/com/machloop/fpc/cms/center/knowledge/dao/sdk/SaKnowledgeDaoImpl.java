...
public class SaKnowledgeDaoImpl implements SaKnowledgeDao {
  ...
  /**
   * @see com.machloop.fpc.cms.center.knowledge.dao.SaKnowledgeDao#queryKnowledgeInfos(String)
   */
  @Override
  ...
  /**
   * @see com.machloop.fpc.cms.center.knowledge.dao.SaKnowledgeDao#queryKnowledgeRules(String)
   */
  @Override
