package com.machloop.fpc.cms.baseline.calculate;
...
public class CalculateResult {
  ...
  public String toString() {
    return "CalculateResult [missionId=" + missionId + ", sourceType=" + sourceType + ", sourceId="
        + sourceId + ", alertNetworkId=" + alertNetworkId + ", alertNetworkGroupId="
        + alertNetworkGroupId + ", alertServiceId=" + alertServiceId + ", calculateTime="
        + calculateTime + ", value=" + value + ", success=" + success + "]";
  }
