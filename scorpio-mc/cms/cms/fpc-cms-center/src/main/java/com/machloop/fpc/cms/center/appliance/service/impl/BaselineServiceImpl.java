...
public class BaselineServiceImpl implements BaselineService {
  ...
  private static final String WINDOWING_MODEL_DAY_ON_DAY_BASIS = String.join(",",
      FpcCmsConstants.BASELINE_WINDOWING_MODEL_MINUTE_OF_DAY,
      FpcCmsConstants.BASELINE_WINDOWING_MODEL_FIVE_MINUTE_OF_DAY,
      FpcCmsConstants.BASELINE_WINDOWING_MODEL_HOUR_OF_DAY);
  private static final String WINDOWING_MODEL_WEEK_ON_WEEK_BASIS = String.join(",",
      FpcCmsConstants.BASELINE_WINDOWING_MODEL_MINUTE_OF_WEEK,
      FpcCmsConstants.BASELINE_WINDOWING_MODEL_FIVE_MINUTE_OF_WEEK,
      FpcCmsConstants.BASELINE_WINDOWING_MODEL_HOUR_OF_WEEK);
  private static final String WINDOWING_MODEL_TIME_ON_TIME_RATIO = String.join(",",
      FpcCmsConstants.BASELINE_WINDOWING_MODEL_LAST_N_MINUTES,
      FpcCmsConstants.BASELINE_WINDOWING_MODEL_LAST_N_FIVE_MINUTES,
      FpcCmsConstants.BASELINE_WINDOWING_MODEL_LAST_N_HOURS);
  ...
  /**
   * @see com.machloop.fpc.cms.center.appliance.service.BaselineService#queryBaselineSettings(java.lang.String, java.lang.String, java.lang.String)
   */
  @Override
  public List<BaselineSettingBO> queryBaselineSettings(String sourceType, String networkId,
    ...
    List<BaselineSettingDO> baselineSettings = baselineSettingDao.queryBaselineSettings(sourceType,
        networkId, networkGroupId, serviceId, null);
    Map<String,
    ...
    baselineSettings.forEach(baselineSettingDO -> {
      ...
      key.append(baselineSettingDO.getSourceType()).append("_")
          ...
          .append(baselineSettingDO.getNetworkGroupId()).append("_")
  ...
  /**
   * @see com.machloop.fpc.cms.center.appliance.service.BaselineService#querySubdivisionBaselineSettings(java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String)
   */
  @Override
  public List<BaselineSettingBO> querySubdivisionBaselineSettings(String sourceType,
      String networkId, String networkGroupId, String serviceId, String category) {
    List<BaselineSettingDO> baselineSettings = baselineSettingDao.queryBaselineSettings(sourceType,
        networkId, networkGroupId, serviceId, category);
  ...
  /**
   * 
   * @see com.machloop.fpc.cms.center.appliance.service.BaselineService#queryWindowingModelByInterval(int)
   */
  @Override
  public List<String> queryWindowingModelByInterval(int interval) {
    ...
    switch (interval) {
      case Constants.ONE_MINUTE_SECONDS:
        result = Lists.newArrayList(FpcCmsConstants.BASELINE_WINDOWING_MODEL_MINUTE_OF_DAY,
            FpcCmsConstants.BASELINE_WINDOWING_MODEL_MINUTE_OF_WEEK,
            FpcCmsConstants.BASELINE_WINDOWING_MODEL_LAST_N_MINUTES);
        break;
      case Constants.FIVE_MINUTE_SECONDS:
        result = Lists.newArrayList(FpcCmsConstants.BASELINE_WINDOWING_MODEL_FIVE_MINUTE_OF_DAY,
            FpcCmsConstants.BASELINE_WINDOWING_MODEL_FIVE_MINUTE_OF_WEEK,
            FpcCmsConstants.BASELINE_WINDOWING_MODEL_LAST_N_FIVE_MINUTES);
        break;
      case Constants.ONE_HOUR_SECONDS:
        result = Lists.newArrayList(FpcCmsConstants.BASELINE_WINDOWING_MODEL_HOUR_OF_DAY,
            FpcCmsConstants.BASELINE_WINDOWING_MODEL_HOUR_OF_WEEK,
            FpcCmsConstants.BASELINE_WINDOWING_MODEL_LAST_N_HOURS);
        break;
      default:
  ...
  /**
   * @see com.machloop.fpc.cms.center.appliance.service.BaselineService#queryPreviousPeriodTimePeriod(java.util.Date, java.util.Date, com.machloop.fpc.cms.center.appliance.bo.BaselineSettingBO, int)
   */
  @Override
  ...
  public int updateBaselineSettings(List<BaselineSettingBO> baselineSettings, String operatorId) {
    ...
    List<BaselineSettingBO> settings = queryBaselineSettings(item.getSourceType(),
        item.getNetworkId(), item.getNetworkGroupId(), item.getServiceId());
    Map<String,
    ...
    for (BaselineSettingBO baselineSettingBO : baselineSettings) {
      ...
      List<BaselineSettingDO> list = CsvUtils
          .convertCSVToList(baselineSettingBO.getWindowingModel()).stream().map(windowingModel -> {
            ...
            baselineSettingDO
                .setNetworkId(StringUtils.defaultIfBlank(baselineSettingBO.getNetworkId(), ""));
            baselineSettingDO.setNetworkGroupId(
                StringUtils.defaultIfBlank(baselineSettingBO.getNetworkGroupId(), ""));
            baselineSettingDO
  ...
  /**
   * @see com.machloop.fpc.cms.center.appliance.service.BaselineService#deleteBaselineSettings(java.lang.String, java.lang.String, java.lang.String, java.lang.String)
   */
  @Override
  public int deleteBaselineSettings(String sourceType, String networkId, String networkGroupId,
      String serviceId) {

    return baselineSettingDao.deleteBaselineSetting(sourceType, networkId, networkGroupId,
        serviceId);
  }

  /**
   * @see com.machloop.fpc.cms.center.appliance.service.BaselineService#queryBaselineValue(java.lang.String, java.lang.String, java.util.Date, java.util.Date)
   */
  @Override
