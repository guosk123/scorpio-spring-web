...
public interface FileRestoreInfoDao {
  ...
  Tuple2<String, List<String>> queryLogRecords(LogRecordQueryVO queryVO,
      List<String> analysisResultIds, Sort sort, int count);

  List<FileRestoreInfoDO> queryFileRestoreInfosByIds(String tableName, String dataColumns,
      List<String> tmpIds, Sort sort);
}
