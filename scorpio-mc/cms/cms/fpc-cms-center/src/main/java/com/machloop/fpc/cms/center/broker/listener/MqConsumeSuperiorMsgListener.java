 ...
 */
@Component
public class MqConsumeSuperiorMsgListener implements MessageListenerOrderly {

  private static final Logger LOGGER = LoggerFactory.getLogger(MqConsumeSuperiorMsgListener.class);
    ...
    for (MessageExt messageExt : msgs) {
      ...
      if (MapUtils.isNotEmpty(properties)) {
        ...
        if (StringUtils.isNotBlank(vaildDeviceType) && StringUtils.isNotBlank(serialNumber)
            && (!StringUtils.equals(vaildDeviceType, FpcCmsConstants.DEVICE_TYPE_CMS)
      ...
      ConsumeOrderlyStatus consumeOrderlyStatus = receiveService.receiveConfiguration(messageExt);
