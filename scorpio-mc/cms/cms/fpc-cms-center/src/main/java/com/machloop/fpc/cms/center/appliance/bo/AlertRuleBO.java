...
public class AlertRuleBO implements LogAudit {
  ...
  public String toString() {
    return "AlertRuleBO [id=" + id + ", assignId=" + assignId + ", name=" + name + ", category="
        + category + ", level=" + level + ", thresholdSettings=" + thresholdSettings
        + ", trendSettings=" + trendSettings + ", advancedSettings=" + advancedSettings
        + ", refire=" + refire + ", status=" + status + ", networkIds=" + networkIds
        + ", serviceIds=" + serviceIds + ", description=" + description + ", createTime="
