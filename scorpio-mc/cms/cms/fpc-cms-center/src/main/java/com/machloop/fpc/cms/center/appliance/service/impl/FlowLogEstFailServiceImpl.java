...
public class FlowLogEstFailServiceImpl implements FlowLogEstFailService {
  ...
  /**
   * @see com.machloop.fpc.cms.center.appliance.service.FlowLogEstFailService#queryFlowLogs(java.lang.String, com.machloop.alpha.common.base.page.Pageable, com.machloop.fpc.cms.center.appliance.vo.FlowLogQueryVO, java.lang.String)
   */
  @Override
  ...
  /**
   * @see com.machloop.fpc.cms.center.appliance.service.FlowLogEstFailService#queryFlowLogStatistics(java.lang.String, com.machloop.fpc.cms.center.appliance.vo.FlowLogQueryVO)
   */
  @Override
  ...
  /**
   * @see com.machloop.fpc.cms.center.appliance.service.FlowLogEstFailService#exportFlowLogs(java.lang.String, com.machloop.fpc.cms.center.appliance.vo.FlowLogQueryVO, java.lang.String, com.machloop.alpha.common.base.page.Sort, java.io.OutputStream)
   */
  @Override
  public void exportFlowLogs(String queryId, FlowLogQueryVO queryVO, String columns, Sort sort,
    ...
    Map<String, String> networkDict = networkService.querySensorNetworks().stream()
        .collect(Collectors.toMap(SensorNetworkBO::getId, SensorNetworkBO::getName));
    ...
    for (Map<String, Object> item : result) {
      String line = transFlowLogMapToStr(item, titles, networkDict, serviceDict,
  ...
  private String transFlowLogMapToStr(Map<String, Object> item, List<String> titles,
      ...
      Map<String, String> tcpSessionStateDict, Map<String, String> ipLocalityDict) {
