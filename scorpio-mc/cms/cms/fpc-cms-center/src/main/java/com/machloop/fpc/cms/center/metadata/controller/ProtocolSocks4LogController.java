...
import com.machloop.fpc.cms.center.metadata.vo.ProtocolSocks4LogVO;

/**
 * @author minjiajun
 *
 * create at 2022年5月30日, fpc-cms-center
 */
@Validated
@RestController
@RequestMapping("/webapi/fpc-cms-v1/metadata")
public class ProtocolSocks4LogController {

  private static final Logger LOGGER = LoggerFactory.getLogger(ProtocolSocks4LogController.class);

  @Autowired
  @Qualifier("protocolSocks4LogService")
  private LogRecordService<ProtocolSocks4LogVO> logRecordService;

  @GetMapping("/protocol-socks4-logs")
  @Secured({"PERM_USER"})
  public Page<ProtocolSocks4LogVO> queryLogRecords(
  ...
  @GetMapping("/protocol-socks4-logs/as-statistics")
  @Secured({"PERM_USER"})
  ...
  @GetMapping("/protocol-socks4-logs/via-dsl")
  @Secured({"PERM_USER"})
  public String queryLogRecordViaDsl(@RequestParam String dsl) {
    return logRecordService.queryLogRecordsViaDsl(dsl);
  }

  @GetMapping("/protocol-socks4-logs/{id}")
  @Secured({"PERM_USER"})
  public ProtocolSocks4LogVO queryLogRecord(@PathVariable String id, LogRecordQueryVO queryVO) {

    return logRecordService.queryLogRecord(queryVO, id);
  }

  @GetMapping("/protocol-socks4-logs/as-export")
  @Secured({"PERM_USER"})
  public void exportLogRecords(@RequestParam(required = false, defaultValue = "") String startTime,
    ...
    try (OutputStream out = response.getOutputStream();) {
      ...
      LOGGER.warn("export socks4 logs error ", e);
    }
  }
}
