...
public class AlertMessageBO implements LogAudit {
  ...
  public String toAuditLogText(int auditLogAction) {
    ...
    builder.append("网络组id:" + networkGroupId + ";");
  ...
  public String toString() {
    return "AlertMessageBO [id=" + id + ", alertId=" + alertId + ", networkId=" + networkId
        + ", networkGroupId=" + networkGroupId + ", serviceId=" + serviceId + ", name=" + name
        + ", category=" + category + ", level=" + level + ", alertDefine=" + alertDefine
        + ", components=" + components + ", ariseTime=" + ariseTime + ", status=" + status
        + ", solver=" + solver + ", solveTime=" + solveTime + ", reason=" + reason + "]";
  }
