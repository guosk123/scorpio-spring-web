...
import com.machloop.fpc.cms.center.appliance.vo.DomainWhiteListVO;

/**
 * @author chenshimiao
 * <p>
 * create at 2022/12/9 4:58 PM,cms
 * @version 1.0
 */
@Validated
@RestController
...
public class DomainWhiteListController {
  ...
  public void importDomainWhiteList(@RequestParam MultipartFile file) {
    ...
    domainWhiteListService.importDomainWhiteList(file, LoggedUserContext.getCurrentUser().getId());
  }
