...
@Order(10)
@Service
public class SendRuleServiceImpl
    implements SendRuleService, MQAssignmentService, SyncConfigurationService {

  private static final List<String> TAGS = Lists.newArrayList(FpcCmsConstants.MQ_TAG_SENDRULE);
  @Autowired
  ...
  static {
    clickHouseTables.put("d_fpc_protocol_mysql_log_record", "mysql");
    clickHouseTables.put("d_fpc_protocol_postgresql_log_record", "pgsql");
    clickHouseTables.put("d_fpc_protocol_arp_log_record", "arp");
    clickHouseTables.put("d_fpc_protocol_sip_log_record", "sip");
    clickHouseTables.put("d_fpc_protocol_dns_log_record", "dns");
    clickHouseTables.put("d_fpc_protocol_icmp_log_record", "icmp");
    clickHouseTables.put("d_fpc_protocol_ssh_log_record", "ssh");
    clickHouseTables.put("d_fpc_protocol_dhcp_log_record", "dhcp");
    clickHouseTables.put("d_fpc_protocol_ssl_log_record", "ssl");
    clickHouseTables.put("d_fpc_protocol_ftp_log_record", "ftp");
    clickHouseTables.put("d_fpc_protocol_telnet_log_record", "telnet");
    clickHouseTables.put("d_fpc_protocol_socks4_log_record", "socks4");
    clickHouseTables.put("d_fpc_protocol_socks5_log_record", "socks5");
    clickHouseTables.put("d_fpc_protocol_mail_log_record", "mail");
    clickHouseTables.put("d_fpc_protocol_tds_log_record", "tds");
    clickHouseTables.put("d_fpc_protocol_tns_log_record", "tns");
    clickHouseTables.put("d_fpc_protocol_db2_log_record", "db2");
    clickHouseTables.put("d_fpc_protocol_http_log_record", "http_new");
    clickHouseTables.put("d_fpc_protocol_ospf_log_record", "ospf");
    clickHouseTables.put("d_fpc_protocol_ldap_log_record", "ldap");
    clickHouseTables.put("d_fpc_flow_log_record", "flowlog");
    clickHouseTables.put("d_fpc_analysis_suricata_alert_message", "suricata");

    clickHouseTables.put("d_fpc_metric_forward_data_record", "statistics_forward");
    clickHouseTables.put("d_fpc_metric_dhcp_data_record", "statistics_dhcp");
    clickHouseTables.put("d_fpc_metric_http_request_data_record", "http_request_info");
    clickHouseTables.put("d_fpc_metric_disk_io_data_record", "metric_diskio");
    clickHouseTables.put("d_fpc_metric_l3device_data_record", "statistics_l3device");
    clickHouseTables.put("d_fpc_metric_port_data_record", "statistics_port");
    clickHouseTables.put("d_fpc_metric_location_data_record", "statistics_location");
    clickHouseTables.put("d_fpc_metric_network_data_record", "statistics_network");
    clickHouseTables.put("d_fpc_metric_l2device_data_record", "statistics_l2device");
    clickHouseTables.put("d_fpc_metric_service_data_record", "statistics_service");
    clickHouseTables.put("d_fpc_metric_dscp_data_record", "statistics_dscp");
    clickHouseTables.put("d_fpc_metric_os_data_record", "http_terminal_info");
    clickHouseTables.put("d_fpc_metric_monitor_data_record", "system_monitor");
    clickHouseTables.put("d_fpc_metric_http_analysis_data_record", "http_status_info");
    clickHouseTables.put("d_fpc_metric_application_data_record", "statistics_application");
    clickHouseTables.put("d_fpc_metric_hostgroup_data_record", "statistics_hostgroup");
    clickHouseTables.put("d_fpc_metric_netif_data_record", "statistics_netif");
    clickHouseTables.put("d_fpc_metric_ip_conversation_data_record", "statistics_ip_conversation");
    clickHouseTables.put("d_fpc_metric_l7protocol_data_record", "statistics_l7protocol");
  }
  ...
  public SendRuleBO saveSendRule(SendRuleBO sendRuleBO, String operatorId) {
    ...
    List<Map<String, Object>> messageBodys = Lists
        .newArrayList(sendRule2MessageBody(sendRuleDO, FpcCmsConstants.SYNC_ACTION_ADD));
    assignmentConfiguration(messageBodys, FpcCmsConstants.MQ_TOPIC_CMS_ASSIGNMENT,
        FpcCmsConstants.MQ_TAG_SENDRULE, null);
  ...
  public SendRuleBO updateSendRule(SendRuleBO sendRuleBO, String id, String operatorId) {
    ...
    BeanUtils.copyProperties(sendRuleDO, sendRuleBO);
    List<Map<String, Object>> messageBodys = Lists
        .newArrayList(sendRule2MessageBody(sendRuleDO, FpcCmsConstants.SYNC_ACTION_MODIFY));
    assignmentConfiguration(messageBodys, FpcCmsConstants.MQ_TOPIC_CMS_ASSIGNMENT,
        FpcCmsConstants.MQ_TAG_SENDRULE, null);
    return sendRuleBO;
  }
  ...
  public SendRuleBO deleteSendRule(String id, String operatorId, boolean forceDelete) {
    ...
    List<Map<String, Object>> messageBodys = Lists
        .newArrayList(sendRule2MessageBody(exist, FpcCmsConstants.SYNC_ACTION_DELETE));
    assignmentConfiguration(messageBodys, FpcCmsConstants.MQ_TOPIC_CMS_ASSIGNMENT,
        FpcCmsConstants.MQ_TAG_SENDRULE, null);
  ...
  public Map<String, List<String>> getFullConfigurationIds(String deviceType, String serialNumber,
    ...
    map.put(FpcCmsConstants.MQ_TAG_SENDRULE, sendRuleDao.querySendRuleIds(false));
    return map;
  }
  ...
  public Tuple3<Boolean, List<Map<String, Object>>, Message> getFullConfigurations(
    ...
    if (StringUtils.equals(tag, FpcCmsConstants.MQ_TAG_SENDRULE)) {
      List<SendRuleDO> sendRuleDOList = sendRuleDao.querySendRules();
      List<Map<String, Object>> list = sendRuleDOList.stream()
          .map(sendRuleDO -> sendRule2MessageBody(sendRuleDO, FpcCmsConstants.SYNC_ACTION_ADD))
          .collect(Collectors.toList());
  ...
  private Map<String, Object> sendRule2MessageBody(SendRuleDO sendRuleDO, String action) {
    Map<String, Object> map = Maps.newHashMapWithExpectedSize(Constants.MAP_DEFAULT_SIZE);
    map.put("id", sendRuleDO.getId());
    map.put("name", sendRuleDO.getName());
    map.put("sendRuleContent", sendRuleDO.getSendRuleContent());
  ...
  @PostConstruct
  public void init() {
    MQReceiveServiceImpl.register(this, Lists.newArrayList(FpcCmsConstants.MQ_TAG_SENDRULE));
  }
  ...
  private int syncSendRule(Map<String, Object> messageBody) {
    ...
    SendRuleBO sendRuleBO = new SendRuleBO();
    sendRuleBO.setId(assignId);
    sendRuleBO.setAssignId(assignId);
    sendRuleBO.setName(name);
    sendRuleBO.setSendRuleContent(MapUtils.getString(messageBody, "sendRuleContent"));

    SendRuleDO exist = sendRuleDao.querySendRuleByAssignId(sendRuleBO.getAssignId());
  ...
  public List<String> getAssignConfigurationIds(String tag, Date beforeTime) {
    return sendRuleDao.queryAssignSendRuleIds(beforeTime).stream().map(SendRuleDO::getAssignId)
        .collect(Collectors.toList());
  }
