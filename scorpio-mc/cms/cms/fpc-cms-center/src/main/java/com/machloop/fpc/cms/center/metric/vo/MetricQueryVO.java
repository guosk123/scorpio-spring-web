...
public class MetricQueryVO implements LogAudit {
  ...
  public String toString() {
    return "MetricQueryVO{" + "queryId='" + queryId + '\'' + ", sourceType='" + sourceType + '\''
        + ", startTime='" + startTime + '\'' + ", endTime='" + endTime + '\'' + ", startTimeDate="
        + startTimeDate + ", endTimeDate=" + endTimeDate + ", networkId='" + networkId + '\''
        + ", networkGroupId='" + networkGroupId + '\'' + ", serviceId='" + serviceId + '\''
        + ", interval=" + interval + ", dsl='" + dsl + '\'' + ", includeStartTime="
        + includeStartTime + ", includeEndTime=" + includeEndTime + ", count=" + count
        + ", drilldown='" + drilldown + '\'' + ", realTime='" + realTime + '\'' + ", packetFileId='"
        + packetFileId + '\'' + ", timePrecision=" + timePrecision + ", columns='" + columns + '\''
