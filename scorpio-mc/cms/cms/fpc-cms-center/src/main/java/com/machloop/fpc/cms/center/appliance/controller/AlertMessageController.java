...
public class AlertMessageController {
  ...
  @Secured({"PERM_USER"})
  public long countAlertMessage(AlertMessageQueryVO queryVO) {
    if (StringUtils.isNotBlank(queryVO.getStartTime())) {
      queryVO
          .setStartTime(DateUtils.toStringFormat(DateUtils.parseISO8601Date(queryVO.getStartTime()),
              "yyyy-MM-dd HH:mm:ss", ZoneOffset.UTC));
    ...
    return alertMessageService.countAlertMessages(queryVO);
  }
  ...
  private void enrichQuery(AlertMessageQueryVO queryVO) {
