...
public class IngestPolicyDO extends BaseOperateDO {
  ...
  public String toString() {
    return "IngestPolicyDO [assignId=" + assignId + ", name=" + name + ", defaultAction="
        + defaultAction + ", deduplication=" + deduplication + ", exceptBpf=" + exceptBpf
        + ", exceptTuple=" + exceptTuple + ", description=" + description + "]";
  }
