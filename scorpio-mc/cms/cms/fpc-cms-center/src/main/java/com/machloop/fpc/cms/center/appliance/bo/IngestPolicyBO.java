...
public class IngestPolicyBO implements LogAudit {
  ...
  public String toString() {
    return "IngestPolicyBO [id=" + id + ", assignId=" + assignId + ", name=" + name
        + ", defaultAction=" + defaultAction + ", exceptBpf=" + exceptBpf + ", exceptTuple="
        + exceptTuple + ", deduplication=" + deduplication + ", description=" + description
        + ", operatorId=" + operatorId + ", createTime=" + createTime + ", updateTime=" + updateTime
        + ", defaultActionText=" + defaultActionText + ", deduplicationText=" + deduplicationText
