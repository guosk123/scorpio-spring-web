 ...
 */
public class MetricLocationDataRecordDO extends AbstractDataRecordDO {
  ...
  public String toString() {
    return "MetricLocationDataRecordDO [countryId=" + countryId + ", provinceId=" + provinceId
        + ", cityId=" + cityId + ", bytepsPeak=" + bytepsPeak + ", downstreamBytes="
        ...
        + "tcpZeroWindowPackets" + tcpZeroWindowPackets + "]";
  }
