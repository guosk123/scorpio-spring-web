 ...
 * @author chenshimiao
 *
 * create at 2022/10/10 4:36 PM,cms
 * @version 1.0
 */
public class SuricataRuleModificationVO {
  ...
  public String toString() {
    return "SuricataRuleModificationVO [action=" + action + ", protocol=" + protocol + ", srcIp="
        + srcIp + ", srcPort=" + srcPort + ", direction=" + direction + ", destIp=" + destIp
        + ", destPort=" + destPort + ", msg=" + msg + ", content=" + content + ", priority="
        + priority + ", classtypeId=" + classtypeId + ", mitreTacticId=" + mitreTacticId
