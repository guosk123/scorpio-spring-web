...
public class BaselineSettingDaoImpl implements BaselineSettingDao {
  ...
  private static final String TABLE_APPLIANCE_BASELINE_SETTINGS = "fpccms_appliance_baseline_settings";

  @Autowired
  private NamedParameterJdbcTemplate jdbcTemplate;

  /**
   * @see com.machloop.fpc.cms.center.appliance.dao.BaselineSettingDao#queryBaselineSettings()
   */
  @Override
  public List<BaselineSettingDO> queryBaselineSettings() {
    StringBuilder sql = new StringBuilder();
    sql.append(" select id, source_type, network_id, network_group_id, service_id, category, ");
    sql.append(" weighting_model, windowing_model, windowing_count, update_time ");
  ...
  /**
   * @see com.machloop.fpc.cms.center.appliance.dao.BaselineSettingDao#queryBaselineSettings(java.lang.String, java.lang.String, java.lang.String, java.lang.String)
   */
  @Override
  ...
  /**
   * @see com.machloop.fpc.cms.center.appliance.dao.BaselineSettingDao#batchUpdateBaselineSetting(java.util.List)
   */
  @Override
  public int batchUpdateBaselineSetting(List<BaselineSettingDO> baselineSettingDOList) {
    ...
    if (StringUtils.isNotBlank(baselineSettingDO.getNetworkGroupId())) {
      deleteSql.append(" and network_group_id = :networkGroupId ");
    }
    ...
    saveSql.append(
        " (id, source_type, network_id, network_group_id, service_id, category, weighting_model, ");
    saveSql.append(" windowing_model, windowing_count, update_time, operator_id) ");
    saveSql.append(
        "values(:id, :sourceType, :networkId, :networkGroupId, :serviceId, :category, :weightingModel, ");
  ...
  /**
   * @see com.machloop.fpc.cms.center.appliance.dao.BaselineSettingDao#deleteBaselineSetting(java.lang.String, java.lang.String, java.lang.String)
   */
  @Override
  public int deleteBaselineSetting(String sourceType, String networkId, String networkGroupId,
      String serviceId) {
    StringBuilder sql = new StringBuilder();
    ...
    baselineSettingDO.setNetworkGroupId(networkGroupId);
