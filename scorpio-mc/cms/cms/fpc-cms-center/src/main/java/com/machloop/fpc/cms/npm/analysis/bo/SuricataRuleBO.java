 ...
 * @author chenshimiao
 *
 * create at 2022/10/10 2:51 PM,cms
 * @version 1.0
 */
public class SuricataRuleBO implements LogAudit {
  ...
  public String toString() {
    return "SuricataRuleBO [id=" + id + ", assignId=" + assignId + ", sid=" + sid + ", action="
        + action + ", protocol=" + protocol + ", srcIp=" + srcIp + ", srcPort=" + srcPort
        + ", direction=" + direction + ", destIp=" + destIp + ", destPort=" + destPort + ", msg="
        + msg + ", rev=" + rev + ", content=" + content + ", priority=" + priority
