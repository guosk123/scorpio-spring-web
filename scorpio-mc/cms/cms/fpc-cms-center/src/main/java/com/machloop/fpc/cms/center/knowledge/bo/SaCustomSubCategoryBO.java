...
public class SaCustomSubCategoryBO implements LogAudit {
  ...
  public String toString() {
    return "SaCustomSubCategoryBO [id=" + id + ", assignId=" + assignId + ", name=" + name
        + ", subCategoryId=" + subCategoryId + ", categoryId=" + categoryId + ", applicationIds="
        + applicationIds + ", description=" + description + ", createTime=" + createTime
