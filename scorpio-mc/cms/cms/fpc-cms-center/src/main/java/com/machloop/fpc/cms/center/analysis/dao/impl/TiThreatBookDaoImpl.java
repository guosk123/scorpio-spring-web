package com.machloop.fpc.cms.center.analysis.dao.impl;
 ...
 */
@Repository
public class TiThreatBookDaoImpl implements TiThreatBookDao {

  private static final String TABLE_ANALYSIS_TI_THREATBOOK = "fpccms_analysis_ti_threatbook";
