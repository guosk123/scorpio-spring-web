...
import com.machloop.fpc.cms.center.knowledge.dao.SaKnowledgeDao;
...
@Order(1)
@Service
public class SaServiceImpl implements SaService, MQAssignmentService, SyncConfigurationService {

  private static final List<String> TAGS = Lists.newArrayList(
      FpcCmsConstants.MQ_TAG_CUSTOMAPPLICATION, FpcCmsConstants.MQ_TAG_CUSTOMSUBCATEGORY,
      FpcCmsConstants.MQ_TAG_CUSTOMCATEGORY, FpcCmsConstants.MQ_TAG_SAKNOWLEDGE);
  ...
  private static final String SA_TYPE_SUBCATEGORY = String
      .valueOf(FpcCmsConstants.METRIC_TYPE_APPLICATION_SUBCATEGORY);
  private static final String SA_TYPE_APPLICATION = String
      .valueOf(FpcCmsConstants.METRIC_TYPE_APPLICATION_APP);
  ...
  /**
   * @see com.machloop.fpc.cms.center.knowledge.service.SaService#queryKnowledgeInfos()
   */
  @Override
  ...
  /**
   * @see com.machloop.fpc.cms.center.knowledge.service.SaService#queryKnowledgeRules()
   */
  @Override
  ...
  /**
   * @see com.machloop.fpc.cms.center.knowledge.service.SaService#importKnowledges(MultipartFile)
   */
  @Override
    ...
    try {
      ...
      try {
        ...
        Message message = MQMessageHelper.convertToMessage(inputStream,
            FpcCmsConstants.MQ_TOPIC_CMS_ASSIGNMENT, FpcCmsConstants.MQ_TAG_SAKNOWLEDGE, null);
        assignmentConfiguration(message, FpcCmsConstants.MQ_TOPIC_CMS_ASSIGNMENT);
      } catch (IllegalStateException | IOException e) {
        throw new BusinessException(ErrorCode.COMMON_BASE_API_INVOKE_ERROR, "下发SA知识库文件失败");
      }
  ...
  /**
   * 
   * @see com.machloop.fpc.cms.center.knowledge.service.SaService#importKnowledges(java.io.FileInputStream)
   */
  @Override
  public synchronized SaKnowledgeInfoBO importKnowledges(FileInputStream inputStream) {
  ...
  /**
   * @see com.machloop.fpc.cms.center.knowledge.service.SaService#exportCustomRules()
   */
  @Override
  public List<String> exportCustomRules() {
    ...
    saCustomCategorys.forEach(customCategory -> {
      result.add(
          CsvUtils.spliceRowData(FpcCmsConstants.SA_TYPE_CUSTOM_CATEGORY, customCategory.getName(),
    ...
    saCustomSubCategorys.forEach(customSubCategory -> {
      ...
      result.add(CsvUtils.spliceRowData(FpcCmsConstants.SA_TYPE_CUSTOM_SUBCATEGORY,
    ...
    saCustomApps.forEach(customApp -> {
      ...
      result.add(CsvUtils.spliceRowData(FpcCmsConstants.SA_TYPE_CUSTOM_APPLICATION,
  ...
  /**
   * @see com.machloop.fpc.cms.center.knowledge.service.SaService#importCustomRules(MultipartFile, String)
   */
  @Transactional
  @Override
  public synchronized int importCustomRules(MultipartFile file, String operatorId) {
    ...
    try (InputStream stream = file.getInputStream();
      ...
      while ((line = reader.readLine()) != null) {
        ...
        switch (contents.get(0)) {
          case FpcCmsConstants.SA_TYPE_CUSTOM_CATEGORY:
            categoryLines.put(lineNumber, contents);
            break;
          case FpcCmsConstants.SA_TYPE_CUSTOM_SUBCATEGORY:
            subcategoryLines.put(lineNumber, contents);
            break;
          case FpcCmsConstants.SA_TYPE_CUSTOM_APPLICATION:
    ...
    if (MapUtils.isNotEmpty(categoryLines)) {
      ...
      // categoryLines导入文件中的分类, categorys库文件分类与自定义分类汇总, subCategorys库文件子分类与自定义子分类汇总,newSubcategorys,
      // customCategorySize自定义分类数量, customSubCategorySize自定义子分类数量
    }
          ...
          for (String appName : selectedApps) {
            if (appSurplus > 0) {
              String applicationId = globalSettingService.generateSequence(
                  CenterConstants.GLOBAL_SETTING_SA_CUSTOM_APPLICATION_SEQ_KEY, "");
   ...
   */
  /**
   * @see com.machloop.fpc.cms.center.knowledge.service.SaService#queryCustomCategorys()
   */
  @Override
  ...
  /**
   * @see com.machloop.fpc.cms.center.knowledge.service.SaService#queryCustomCategory(String)
   */
  @Override
  ...
  /**
   * @see com.machloop.fpc.cms.center.knowledge.service.SaService#saveCustomCategory(com.machloop.fpc.cms.center.knowledge.bo.SaCustomCategoryBO, String)
   */
  @Transactional
  @Override
  public synchronized SaCustomCategoryBO saveCustomCategory(SaCustomCategoryBO customCategoryBO,
    ...
    if (StringUtils.isNotBlank(existNameDO.getId()) || isNameRepetition(customCategoryBO.getName(),
        FpcCmsConstants.METRIC_TYPE_APPLICATION_CATEGORY)) {
    ...
    // 保存分类
    customCategoryDO = customCategoryDao.saveSaCustomCategory(customCategoryDO);
    ...
    // 下发到直属fpc和cms
    customCategoryBO.setId(customCategoryDO.getId());
    List<Map<String, Object>> messageBodys = Lists.newArrayList(
        customCategory2MessageBody(customCategoryBO, FpcCmsConstants.SYNC_ACTION_ADD));
    assignmentConfiguration(messageBodys, FpcCmsConstants.MQ_TOPIC_CMS_ASSIGNMENT,
        FpcCmsConstants.MQ_TAG_CUSTOMCATEGORY, null);
  ...
  private String generateCategoryId() {
    String categoryId = globalSettingService
        .generateSequence(CenterConstants.GLOBAL_SETTING_SA_CUSTOM_CATEGORY_SEQ_KEY, "");
    if (Integer.parseInt(categoryId) == (CUSTOM_CATEGORY_INITIATION_ID + MAXIMUM_AMOUNT_CATEGORY)) {
      globalSettingService.setValue(CenterConstants.GLOBAL_SETTING_SA_CUSTOM_CATEGORY_SEQ_KEY,
          CUSTOM_CATEGORY_INITIATION_ID + "");
      categoryId = globalSettingService
          .getValue(CenterConstants.GLOBAL_SETTING_SA_CUSTOM_CATEGORY_SEQ_KEY);
    }
  ...
  /**
   * @see com.machloop.fpc.cms.center.knowledge.service.SaService#updateCustomCategory(String, com.machloop.fpc.cms.center.knowledge.bo.SaCustomCategoryBO, String)
   */
  @Transactional
  @Override
  public SaCustomCategoryBO updateCustomCategory(String id, SaCustomCategoryBO customCategoryBO,
    ...
    if (CollectionUtils.isEmpty(subCategoryIdList)) {
      ...
      // 下发到直属fpc和cms
      customCategoryBO.setId(id);
      List<Map<String, Object>> messageBodys = Lists.newArrayList(
          customCategory2MessageBody(customCategoryBO, FpcCmsConstants.SYNC_ACTION_MODIFY));
      assignmentConfiguration(messageBodys, FpcCmsConstants.MQ_TOPIC_CMS_ASSIGNMENT,
          FpcCmsConstants.MQ_TAG_CUSTOMCATEGORY, null);
  ...
  /**
   * @see com.machloop.fpc.cms.center.knowledge.service.SaService#deleteCustomCategory(String, String)
   */
  @Override
  public SaCustomCategoryBO deleteCustomCategory(String id, String operatorId,
    ...
    // 下发到直属fpc和cms
    List<Map<String, Object>> messageBodys = Lists.newArrayList(
        customCategory2MessageBody(customCategory, FpcCmsConstants.SYNC_ACTION_DELETE));
    assignmentConfiguration(messageBodys, FpcCmsConstants.MQ_TOPIC_CMS_ASSIGNMENT,
        FpcCmsConstants.MQ_TAG_CUSTOMCATEGORY, null);
   ...
   */
  /**
   * @see com.machloop.fpc.cms.center.knowledge.service.SaService#queryCustomSubCategorys()
   */
  @Override
  ...
  /**
   * @see com.machloop.fpc.cms.center.knowledge.service.SaService#queryCustomSubCategory(String)
   */
  @Override
  ...
  /**
   * @see com.machloop.fpc.cms.center.knowledge.service.SaService#saveCustomSubCategory(com.machloop.fpc.cms.center.knowledge.bo.SaCustomSubCategoryBO, String)
   */
  @Transactional
  @Override
  public synchronized SaCustomSubCategoryBO saveCustomSubCategory(
    ...
    if (StringUtils.isNotBlank(existNameDO.getId()) || isNameRepetition(
        customSubCategoryBO.getName(), FpcCmsConstants.METRIC_TYPE_APPLICATION_SUBCATEGORY)) {
    ...
    // 保存子分类
    customSubCategoryDO = customSubCategoryDao.saveSaCustomSubCategory(customSubCategoryDO);
    ...
    // 下发到直属fpc和cms
    customSubCategoryBO.setId(customSubCategoryDO.getId());
    List<Map<String, Object>> messageBodys = Lists.newArrayList(
        customSubCategory2MessageBody(customSubCategoryBO, FpcCmsConstants.SYNC_ACTION_ADD));
    assignmentConfiguration(messageBodys, FpcCmsConstants.MQ_TOPIC_CMS_ASSIGNMENT,
        FpcCmsConstants.MQ_TAG_CUSTOMSUBCATEGORY, null);
  ...
  private String generateSubCategoryId() {
    ...
    String subCategoryId = globalSettingService
        .generateSequence(CenterConstants.GLOBAL_SETTING_SA_CUSTOM_SUBCATEGORY_SEQ_KEY, "");
    if (Integer.parseInt(
        subCategoryId) == (CUSTOM_SUBCATEGORY_INITIATION_ID + MAXIMUM_AMOUNT_SUBCATEGORY)) {
      globalSettingService.setValue(CenterConstants.GLOBAL_SETTING_SA_CUSTOM_SUBCATEGORY_SEQ_KEY,
          CUSTOM_SUBCATEGORY_INITIATION_ID + "");
      subCategoryId = globalSettingService
          .getValue(CenterConstants.GLOBAL_SETTING_SA_CUSTOM_SUBCATEGORY_SEQ_KEY);
    }
  ...
  /**
   * @see com.machloop.fpc.cms.center.knowledge.service.SaService#updateCustomSubCategory(String, com.machloop.fpc.cms.center.knowledge.bo.SaCustomSubCategoryBO, String)
   */
  @Transactional
  @Override
  public SaCustomSubCategoryBO updateCustomSubCategory(String id,
    ...
    if ((StringUtils.isNotBlank(existNameDO.getId())
        ...
        || isNameRepetition(customSubCategoryBO.getName(),
            FpcCmsConstants.METRIC_TYPE_APPLICATION_SUBCATEGORY)) {
      throw new BusinessException(ErrorCode.COMMON_BASE_FORMAT_INVALID, "子分类名称不能重复，请修改子分类名称");
    }
    ...
    // 下发到直属fpc和cms
    customSubCategoryBO.setId(id);
    List<Map<String, Object>> messageBodys = Lists.newArrayList(
        customSubCategory2MessageBody(customSubCategoryBO, FpcCmsConstants.SYNC_ACTION_MODIFY));
    assignmentConfiguration(messageBodys, FpcCmsConstants.MQ_TOPIC_CMS_ASSIGNMENT,
        FpcCmsConstants.MQ_TAG_CUSTOMSUBCATEGORY, null);
  ...
  /**
   * @see com.machloop.fpc.cms.center.knowledge.service.SaService#deleteCustomSubCategory(String, String)
   */
  @Override
  public SaCustomSubCategoryBO deleteCustomSubCategory(String id, String operatorId,
    ...
    // 下发到直属fpc和cms
    List<Map<String, Object>> messageBodys = Lists.newArrayList(
        customSubCategory2MessageBody(customSubCategory, FpcCmsConstants.SYNC_ACTION_DELETE));
    assignmentConfiguration(messageBodys, FpcCmsConstants.MQ_TOPIC_CMS_ASSIGNMENT,
        FpcCmsConstants.MQ_TAG_CUSTOMSUBCATEGORY, null);
   ...
   */
  /**
   * @see com.machloop.fpc.cms.center.knowledge.service.SaService#queryCustomApps()
   */
  @Override
  ...
  /**
   * @see com.machloop.fpc.cms.center.knowledge.service.SaService#queryCustomApp(String)
   */
  @Override
  ...
  /**
   * @see com.machloop.fpc.cms.center.knowledge.service.SaService#saveCustomApp(com.machloop.fpc.cms.center.knowledge.bo.SaCustomApplicationBO, String)
   */
  @Override
  public synchronized SaCustomApplicationBO saveCustomApp(SaCustomApplicationBO customAppBO,
    ...
    if (StringUtils.isNotBlank(existDO.getId())
        || isNameRepetition(customAppBO.getName(), FpcCmsConstants.METRIC_TYPE_APPLICATION_APP)) {
    ...
    if (StringUtils.isBlank(customAppBO.getApplicationId())) {
      String applicationId = StringUtils.defaultIfBlank(customAppBO.getApplicationId(),
          globalSettingService
              .generateSequence(CenterConstants.GLOBAL_SETTING_SA_CUSTOM_APPLICATION_SEQ_KEY, ""));
    ...
    customAppDO = customAppDao.saveSaCustomApp(customAppDO);

    // 下发到直属fpc和cms
    customAppBO.setId(customAppDO.getId());
    List<Map<String, Object>> messageBodys = Lists
        .newArrayList(customApplication2MessageBody(customAppBO, FpcCmsConstants.SYNC_ACTION_ADD));
    assignmentConfiguration(messageBodys, FpcCmsConstants.MQ_TOPIC_CMS_ASSIGNMENT,
        FpcCmsConstants.MQ_TAG_CUSTOMAPPLICATION, null);

    return queryCustomApp(customAppDO.getId());
  }

  /**
   * @see com.machloop.fpc.cms.center.knowledge.service.SaService#updateCustomApp(String, com.machloop.fpc.cms.center.knowledge.bo.SaCustomApplicationBO, String)
   */
  @Override
  public SaCustomApplicationBO updateCustomApp(String id, SaCustomApplicationBO customAppBO,
    ...
    // 下发到直属fpc和cms
    SaCustomApplicationBO saCustomApplicationBO = new SaCustomApplicationBO();
    BeanUtils.copyProperties(customAppDO, saCustomApplicationBO);
    List<Map<String, Object>> messageBodys = Lists.newArrayList(
        customApplication2MessageBody(saCustomApplicationBO, FpcCmsConstants.SYNC_ACTION_MODIFY));
    assignmentConfiguration(messageBodys, FpcCmsConstants.MQ_TOPIC_CMS_ASSIGNMENT,
        FpcCmsConstants.MQ_TAG_CUSTOMAPPLICATION, null);
  ...
  /**
   * @see com.machloop.fpc.cms.center.knowledge.service.SaService#deleteCustomApp(String, String)
   */
  @Override
  public SaCustomApplicationBO deleteCustomApp(String id, String operatorId, boolean forceDelete) {
    ...
    // 下发到直属fpc和cms
    List<Map<String, Object>> messageBodys = Lists.newArrayList(
        customApplication2MessageBody(customAppBO, FpcCmsConstants.SYNC_ACTION_DELETE));
    assignmentConfiguration(messageBodys, FpcCmsConstants.MQ_TOPIC_CMS_ASSIGNMENT,
        FpcCmsConstants.MQ_TAG_CUSTOMAPPLICATION, null);
  ...
  /**
   * @see com.machloop.fpc.cms.center.knowledge.service.SaService#queryAllAppsIdNameMapping()
   */
  @Override
  ...
  public Map<String, List<String>> getFullConfigurationIds(String deviceType, String serialNumber,
    ...
    try {
      map.put(FpcCmsConstants.MQ_TAG_SAKNOWLEDGE,
          Lists.newArrayList(DigestUtils.md5Hex(new FileInputStream(new File(knowledgeFilePath)))));
    } catch (IllegalStateException | IOException e) {
      throw new BusinessException(ErrorCode.COMMON_BASE_API_INVOKE_ERROR, "加密SA知识库文件失败");
    }

    map.put(FpcCmsConstants.MQ_TAG_CUSTOMCATEGORY,
        customCategoryDao.querySaCustomCategoryIds(false));
    map.put(FpcCmsConstants.MQ_TAG_CUSTOMSUBCATEGORY,
        customSubCategoryDao.querySaCustomSubCategoryIds());
    map.put(FpcCmsConstants.MQ_TAG_CUSTOMAPPLICATION, customAppDao.querySaCustomAppIds());
    return map;
  }
    ...
    if (StringUtils.equals(tag, FpcCmsConstants.MQ_TAG_SAKNOWLEDGE)) {
      ...
      try {
        ...
        message = MQMessageHelper.convertToMessage(inputStream,
            FpcCmsConstants.MQ_TOPIC_CMS_FULL_ASSIGNMENT, FpcCmsConstants.MQ_TAG_SAKNOWLEDGE, null);
      } catch (IllegalStateException | IOException e) {
        throw new BusinessException(ErrorCode.COMMON_BASE_API_INVOKE_ERROR, "获取SA知识库文件失败");
      }
      return Tuples.of(false, Lists.newArrayListWithCapacity(0), message);

    } else if (StringUtils.equals(tag, FpcCmsConstants.MQ_TAG_CUSTOMCATEGORY)) {
      list = queryCustomCategorys().stream()
          .map(customCategory -> customCategory2MessageBody(customCategory,
              FpcCmsConstants.SYNC_ACTION_ADD))
          .collect(Collectors.toList());
      return Tuples.of(true, list, MQMessageHelper.EMPTY);

    } else if (StringUtils.equals(tag, FpcCmsConstants.MQ_TAG_CUSTOMSUBCATEGORY)) {
      list = queryCustomSubCategorys().stream()
          .map(customSubCategory -> customSubCategory2MessageBody(customSubCategory,
              FpcCmsConstants.SYNC_ACTION_ADD))
          .collect(Collectors.toList());
      return Tuples.of(true, list, MQMessageHelper.EMPTY);

    } else if (StringUtils.equals(tag, FpcCmsConstants.MQ_TAG_CUSTOMAPPLICATION)) {
      queryCustomApps().stream().map(
          customApp -> customApplication2MessageBody(customApp, FpcCmsConstants.SYNC_ACTION_ADD))
          .collect(Collectors.toList());
      return Tuples.of(true, list, MQMessageHelper.EMPTY);
    } else {
  ...
  private Map<String, Object> customCategory2MessageBody(SaCustomCategoryBO customCategoryBO,
      String action) {
  ...
  private Map<String, Object> customSubCategory2MessageBody(
      SaCustomSubCategoryBO customSubCategoryBO, String action) {
  ...
  private Map<String, Object> customApplication2MessageBody(SaCustomApplicationBO customAppBO,
      String action) {
  ...
  private int syncSaKonwledge(Message message) {
    ...
    try {
      FileUtils.writeByteArrayToFile(
          new File(HotPropertiesHelper.getProperty("file.sa.knowledge.path")), message.getBody());
      FileInputStream inputStream = new FileInputStream(
          new File(HotPropertiesHelper.getProperty("file.sa.knowledge.path")));
      SaKnowledgeInfoBO result = importKnowledges(inputStream);
  ...
  private int syncCustomCategory(Map<String, Object> messageBody) {
    ...
    SaCustomCategoryBO customCategoryBO = new SaCustomCategoryBO();
    customCategoryBO.setAssignId(assignId);
    customCategoryBO.setId(assignId);
    ...
    SaCustomCategoryDO exist = customCategoryDao
        .queryCustomCategoryByAssignId(customCategoryBO.getAssignId());
  ...
  private int syncCustomSubCategory(Map<String, Object> messageBody) {
    ...
    SaCustomSubCategoryBO customSubCategoryBO = new SaCustomSubCategoryBO();
    customSubCategoryBO.setAssignId(assignId);
    customSubCategoryBO.setId(assignId);
    ...
    SaCustomSubCategoryDO exist = customSubCategoryDao
        .queryCustomSubCategoryByAssignId(customSubCategoryBO.getAssignId());
  ...
  private int syncCustomApplication(Map<String, Object> messageBody) {
    ...
    String action = MapUtils.getString(messageBody, "action");
    SaCustomApplicationBO customApplicationBO = new SaCustomApplicationBO();
    customApplicationBO.setAssignId(assignId);
    customApplicationBO.setId(assignId);
    ...
    SaCustomApplicationDO exist = customAppDao
        .queryCustomAppByAssignId(customApplicationBO.getAssignId());
  ...
  public int clearLocalConfiguration(String tag, boolean onlyLocal, Date beforeTime) {
    ...
    try {
      ...
      exportCustomRules().forEach(item -> content.append(item));
      File tempFile = Paths
          .get(HotPropertiesHelper.getProperty("file.runtime.path"), "customRules.csv").toFile();
      FileUtils.writeByteArrayToFile(tempFile, content.toString().getBytes(StandardCharsets.UTF_8));
    } catch (IOException e) {
      LOGGER.warn("backup customRule msg failed.", e);
    }

    // 删除
    int clearCount = 0;
    if (StringUtils.equals(tag, FpcCmsConstants.MQ_TAG_CUSTOMCATEGORY)) {
      List<String> customCategoryIds = customCategoryDao.querySaCustomCategoryIds(onlyLocal);
      for (String customCategoryId : customCategoryIds) {
        try {
          hierarchyDao.batchDeleteByCategoryId(customCategoryId);
          customAppDao.deleteSaCustomApp(customCategoryId, CMS_ASSIGNMENT);
          customSubCategoryDao.deleteSaCustomSubCategory(customCategoryId, CMS_ASSIGNMENT);
          deleteCustomCategory(customCategoryId, CMS_ASSIGNMENT, true);
          clearCount++;
        } catch (BusinessException e) {
    ...
    if (StringUtils.equals(tag, FpcCmsConstants.MQ_TAG_CUSTOMSUBCATEGORY)) {
      List<String> customSubCategoryIds = customSubCategoryDao.querySaCustomSubCategoryIds();
      for (String customSubCategoryId : customSubCategoryIds) {
        try {
          hierarchyDao.batchDeleteBySubCategoryIds(SA_TYPE_SUBCATEGORY,
              Lists.newArrayList(customSubCategoryId));
          customAppDao.deleteSaCustomApp(customSubCategoryId, CMS_ASSIGNMENT);
          deleteCustomSubCategory(customSubCategoryId, CMS_ASSIGNMENT, true);
          clearCount++;
        } catch (BusinessException e) {
    ...
    if (StringUtils.equals(tag, FpcCmsConstants.MQ_TAG_CUSTOMAPPLICATION)) {
      List<String> customAppIds = customAppDao.querySaCustomAppIds();
      for (String customAppId : customAppIds) {
        try {
          hierarchyDao.batchDeleteByApplicationIds(SA_TYPE_APPLICATION,
              Lists.newArrayList(customAppId));
          deleteCustomApp(customAppId, CMS_ASSIGNMENT, true);
          clearCount++;
        } catch (BusinessException e) {
  ...
  public List<String> getAssignConfigurationIds(String tag, Date beforeTime) {
    ...
    if (StringUtils.equals(tag, FpcCmsConstants.MQ_TAG_CUSTOMCATEGORY)) {
      return customCategoryDao.queryAssignSaCustomCategoryIds(beforeTime).stream()
          .map(e -> e.getAssignId()).collect(Collectors.toList());
    }
    if (StringUtils.equals(tag, FpcCmsConstants.MQ_TAG_CUSTOMSUBCATEGORY)) {
      return customSubCategoryDao.queryAssignSaCustomSubCategoryIds(beforeTime).stream()
          .map(e -> e.getAssignId()).collect(Collectors.toList());
    }
    if (StringUtils.equals(tag, FpcCmsConstants.MQ_TAG_CUSTOMAPPLICATION)) {
      return customAppDao.queryAssignSaCustomAppIds(beforeTime).stream().map(e -> e.getAssignId())
          .collect(Collectors.toList());
    }
