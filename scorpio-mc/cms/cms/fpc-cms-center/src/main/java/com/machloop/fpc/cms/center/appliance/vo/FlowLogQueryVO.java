...
public class FlowLogQueryVO implements LogAudit {
  ...
  public String toString() {
    return "FlowLogQueryVO{" + "id='" + id + '\'' + ", interfaceName='" + interfaceName + '\''
        + ", flowId=" + flowId + ", networkId='" + networkId + '\'' + ", networkGroupId='"
        + networkGroupId + '\'' + ", serviceId='" + serviceId + '\'' + ", startTime='" + startTime
        + '\'' + ", endTime='" + endTime + '\'' + ", startTimeDate=" + startTimeDate
        + ", endTimeDate=" + endTimeDate + ", flowContinued=" + flowContinued + ", packetSigseq='"
        + packetSigseq + '\'' + ", ethernetType=" + ethernetType + ", ethernetInitiator='"
        + ethernetInitiator + '\'' + ", ethernetResponder='" + ethernetResponder + '\''
        + ", ethernetProtocol='" + ethernetProtocol + '\'' + ", vlanId=" + vlanId
        + ", ipLocalityInitiator=" + ipLocalityInitiator + ", ipLocalityResponder="
        + ipLocalityResponder + ", ipInitiator='" + ipInitiator + '\'' + ", ipResponder='"
        + ipResponder + '\'' + ", ipProtocol='" + ipProtocol + '\'' + ", portInitiator='"
        + portInitiator + '\'' + ", portResponder='" + portResponder + '\'' + ", l7ProtocolId='"
        + l7ProtocolId + '\'' + ", applicationIds='" + applicationIds + '\''
        + ", maliciousApplicationIds='" + maliciousApplicationIds + '\'' + ", countryIdInitiator='"
        + countryIdInitiator + '\'' + ", provinceIdInitiator='" + provinceIdInitiator + '\''
        + ", cityIdInitiator='" + cityIdInitiator + '\'' + ", countryIdResponder='"
        + countryIdResponder + '\'' + ", provinceIdResponder='" + provinceIdResponder + '\''
        + ", cityIdResponder='" + cityIdResponder + '\'' + ", locationInitiator='"
        + locationInitiator + '\'' + ", locationResponder='" + locationResponder + '\''
        + ", reportTime='" + reportTime + '\'' + ", duration='" + duration + '\''
        + ", upstreamBytes='" + upstreamBytes + '\'' + ", downstreamBytes='" + downstreamBytes
        + '\'' + ", totalBytes='" + totalBytes + '\'' + ", upstreamPackets='" + upstreamPackets
        + '\'' + ", downstreamPackets='" + downstreamPackets + '\'' + ", totalPackets='"
        + totalPackets + '\'' + ", upstreamPayloadBytes='" + upstreamPayloadBytes + '\''
        + ", downstreamPayloadBytes='" + downstreamPayloadBytes + '\'' + ", totalPayloadBytes='"
        + totalPayloadBytes + '\'' + ", upstreamPayloadPackets='" + upstreamPayloadPackets + '\''
        + ", downstreamPayloadPackets='" + downstreamPayloadPackets + '\''
        + ", totalPayloadPackets='" + totalPayloadPackets + '\'' + ", tcpClientNetworkLatency='"
        + tcpClientNetworkLatency + '\'' + ", tcpServerNetworkLatency='" + tcpServerNetworkLatency
        + '\'' + ", serverResponseLatency='" + serverResponseLatency + '\''
        + ", tcpClientLossBytes='" + tcpClientLossBytes + '\'' + ", tcpServerLossBytes='"
        + tcpServerLossBytes + '\'' + ", tcpClientZeroWindowPackets='" + tcpClientZeroWindowPackets
        ...
        + ", includeEndTime=" + includeEndTime + ", entry='" + entry + '\'' + ", networkIds="
        + networkIds + ", serviceNetworkIds=" + serviceNetworkIds + ", timestamp='" + timestamp
        + '\'' + ", sid=" + sid + '}';
  }
