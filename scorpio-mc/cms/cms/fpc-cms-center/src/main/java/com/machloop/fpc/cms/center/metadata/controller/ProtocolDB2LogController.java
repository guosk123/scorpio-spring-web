...
import com.machloop.fpc.cms.center.metadata.vo.ProtocolDB2LogVO;
...
public class ProtocolDB2LogController {

  private static final Logger LOGGER = LoggerFactory.getLogger(ProtocolDB2LogController.class);

  @Autowired
  @Qualifier("protocolDB2LogService")
  private LogRecordService<ProtocolDB2LogVO> logRecordService;

  @GetMapping("/protocol-db2-logs")
  @Secured({"PERM_USER"})
  public Page<ProtocolDB2LogVO> queryLogRecords(
  ...
  @GetMapping("/protocol-db2-logs/as-statistics")
  @Secured({"PERM_USER"})
  ...
  @GetMapping("/protocol-db2-logs/via-dsl")
  @Secured({"PERM_USER"})
  public String queryLogRecordViaDsl(@RequestParam String dsl) {
    return logRecordService.queryLogRecordsViaDsl(dsl);
  }

  @GetMapping("/protocol-db2-logs/{id}")
  @Secured({"PERM_USER"})
  public ProtocolDB2LogVO queryLogRecord(@PathVariable String id, LogRecordQueryVO queryVO) {

    return logRecordService.queryLogRecord(queryVO, id);
  }

  @GetMapping("/protocol-db2-logs/as-export")
  @Secured({"PERM_USER"})
  public void exportLogRecords(@RequestParam(required = false, defaultValue = "") String startTime,
    ...
    String fileName = StringUtils.equals(fileType, Constants.EXPORT_FILE_TYPE_CSV) ? "db2_logs.csv"
        : "db2_logs.xlsx";
    ...
    try (OutputStream out = response.getOutputStream();) {
      ...
      LOGGER.warn("export db2 logs error ", e);
    }
  }
}
