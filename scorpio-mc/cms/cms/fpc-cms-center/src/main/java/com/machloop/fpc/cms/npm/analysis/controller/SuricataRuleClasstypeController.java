...
import com.machloop.fpc.cms.npm.analysis.vo.SuricataRuleClasstypeCreationVO;
import com.machloop.fpc.cms.npm.analysis.vo.SuricataRuleClasstypeModificationVO;

/**
 * @author chenshimiao
 *
 * create at 2022/10/13 10:26 AM,cms
 * @version 1.0
 */
@RestController
...
public class SuricataRuleClasstypeController {
  ...
  public void importClasstypes(@RequestParam MultipartFile file) {
    ...
    LogHelper.log(LogHelper.LEVEL_NOTICE, LogHelper.CATEGORY_AUDIT,
        "导入" + importClasstypes + "条Suricata规则分类", LoggedUserContext.getCurrentUser().getUsername());
  }
