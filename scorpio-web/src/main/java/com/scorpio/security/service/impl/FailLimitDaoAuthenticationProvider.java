...
public class FailLimitDaoAuthenticationProvider extends DaoAuthenticationProvider {
  ...
  public Authentication authenticate(Authentication authentication) throws AuthenticationException {
    ...
    int fobiddenFailedTimes = Integer
        .parseInt(HotPropertiesHelper.getProperty("loggeduser.forbidden.max.failed"));
    int fobiddenDurationSecond = Integer
        .parseInt(HotPropertiesHelper.getProperty("loggeduser.forbidden.duration.second"));
