...
public class LoggedUser extends User {
  ...
  public LoggedUser(UserDO userDo, Collection<? extends GrantedAuthority> authorities,
      boolean userPasswordNonReliable) {
  ...
  public String toString() {
    return "LoggedUser [fullname=" + fullname + ", appKey=" + appKey + ", remoteAddress="
        + remoteAddress + ", toString()=" + super.toString() + "]";
  }
